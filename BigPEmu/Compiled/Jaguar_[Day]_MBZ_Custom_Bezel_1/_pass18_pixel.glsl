...
vec4 HSM_GetCroppedTexSample(sampler2D in_sampler, vec2 in_screen_coord)
{
    ...
    vec4 _4550 = HSM_GetTexSampleFromSampleStartAndSize(in_sampler, param, param_1, param_2);
    return _4550;
}
...
vec2 HSM_GetGeomCurvedCoord(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, inout float in_distance, float in_aspect)
{
    ...
    vec2 _4057 = transform(param_5, param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 curved_coord = _4057;
    return curved_coord;
}
...
vec2 HSM_GetGeomCurvedCoordRetainWidth(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, float in_distance, float in_aspect)
{
    ...
    vec2 _4074 = HSM_GetGeomCurvedCoord(param, param_1, param_2, param_3, param_4, param_5);
    vec2 ctr_curved_coord = _4074 - vec2(0.5);
    ...
    vec2 _4089 = HSM_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 right_edge_curved_ctr_coord = _4089 - vec2(0.5);
...
vec3 hrg_get_ideal_global_eye_pos_for_points(inout vec3 eye_pos, vec2 output_aspect, vec3 global_coords[9], int num_points, float in_geom_radius, float in_geom_view_dist)
{
    ...
    for (int iter = 0; iter < max_centering_iters; iter++)
    {
        ...
        vec3 _2636 = eye_pos;
        vec2 _2638 = _2636.xy + center_offset;
        eye_pos.x = _2638.x;
        eye_pos.y = _2638.y;
...
vec3 hrg_get_ideal_global_eye_pos(mat3 local_to_global, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist)
{
    ...
    else
    {
        ...
        vec3 _2956 = hrg_get_ideal_global_eye_pos_for_points(param_36, param_37, param_38, param_39, param_40, param_41);
        _2939 = _2956;
    }
    return _2939;
}
...
vec2 hrg_get_curved_video_uv_coords_and_tangent_matrix(vec2 flat_video_uv, vec3 eye_pos_local, vec2 output_pixel_size, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, mat3 global_to_local, out mat2 pixel_to_tangent_video_uv)
{
    ...
    vec3 param_5;
    vec2 _3181 = hrg_view_vec_to_uv(param, param_1, param_2, param_3, param_4, param_5);
    vec3 pos = param_5;
    vec2 centered_uv = _3181;
...
vec2 HRG_GetGeomCurvedCoord(vec2 in_coord, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, float in_geom_tilt_angle_x, float in_geom_tilt_angle_y, float in_screen_aspect, float pin_inner_edge, vec2 in_source_size, vec2 in_output_size, out mat2 pixel_to_video_uv)
{
    ...
    if (in_geom_mode > 0.5)
    {
        ...
        mat2 param_14;
        vec2 _3362 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14);
        pixel_to_video_uv = param_14;
        vec2 ctr_curved_coord = _3362 - vec2(0.5);
        if ((in_geom_tilt_angle_x == 0.0) && (in_geom_tilt_angle_y == 0.0))
        {
            ...
            mat2 param_23;
            vec2 _3391 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_15, param_16, param_17, param_18, param_19, param_20, param_21, param_22, param_23);
            pixel_to_video_uv = param_23;
            vec2 right_edge_curved_ctr_coord = _3391 - vec2(0.5);
            ...
            mat2 param_32;
            vec2 _3413 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_24, param_25, param_26, param_27, param_28, param_29, param_30, param_31, param_32);
            pixel_to_video_uv = param_32;
            vec2 bottom_edge_curved_ctr_coord = _3413 - vec2(0.5);
            ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
        ...
        if (pin_inner_edge == 1.0)
        {
            if (in_geom_tilt_angle_y != 0.0)
            {
                ...
                mat2 param_41;
                vec2 _3456 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_33, param_34, param_35, param_36, param_37, param_38, param_39, param_40, param_41);
                pixel_to_video_uv = param_41;
                vec2 top_edge_curved_ctr_coord = _3456;
            ...
            if (in_geom_tilt_angle_x != 0.0)
            {
                ...
                mat2 param_50;
                vec2 _3485 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_42, param_43, param_44, param_45, param_46, param_47, param_48, param_49, param_50);
                pixel_to_video_uv = param_50;
                vec2 left_edge_curved_ctr_coord = _3485;
...
vec2 HSM_Get2DCurvedCoord(vec2 in_coord, vec2 curvature_values)
{
    ...
    vec2 _4153 = HSM_GetCrtPiCurvedCoord(param, param_1);
    ctr_curved_coord = _4153 - vec2(0.5);
    vec2 param_2 = vec2(1.0, 0.5);
    vec2 param_3 = curvature_values;
    vec2 _4160 = HSM_GetCrtPiCurvedCoord(param_2, param_3);
    vec2 right_edge_curved_ctr_coord = _4160 - vec2(0.5);
    ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
    vec2 param_4 = vec2(0.5, 1.0);
    vec2 param_5 = curvature_values;
    vec2 _4174 = HSM_GetCrtPiCurvedCoord(param_4, param_5);
    vec2 bottom_edge_curved_ctr_coord = _4174 - vec2(0.5);
    ctr_curved_coord.y = (ctr_curved_coord.y * 0.5) / bottom_edge_curved_ctr_coord.y;
    return ctr_curved_coord + vec2(0.5);
}
...
vec2 HSM_GetCurvedCoord(vec2 in_coord, float curvature_multiplier, float screen_aspect)
{
    ...
    if (HSM_CURVATURE_MODE > CURVATURE_MODE_2D_CYLINDER)
    {
        ...
        else
        {
            ...
            mat2 param_16;
            vec2 _4281 = HRG_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16);
...
vec2 HSM_GetCrtShaderFinalCoordExtraVariables(vec2 screen_coord, vec2 screen_scale, float raster_bloom_avg_lum, inout vec2 screen_curved_coord, inout vec2 screen_curved_coord_with_overscan, inout vec2 screen_coord_with_overscan, inout vec2 screen_scale_with_overscan)
{
    ...
    vec2 _4863 = HSM_GetMirrorWrappedCoord(param_1);
    vec2 screen_curved_coord_with_overscan_and_mirror = _4863;
...
void main()
{
    ...
    vec4 _5229 = HSM_UpdateGlobalScreenValuesFromCache(InfoCachePass, param_1);
    ...
    vec2 param_9 = vec2(0.25);
    float gamma_in = 1.0 / HSM_GetCroppedTexSample(LinearizePass, param_9).w;
    vec2 param_10 = vec2(0.75, 0.25);
    float intera = HSM_GetCroppedTexSample(LinearizePass, param_10).w;
    ...
    vec2 param_12 = SCREEN_SCALE;
    float param_13 = raster_bloom_avg_lum;
    vec2 param_14 = screen_curved_coord;
    vec2 param_15 = screen_curved_coord_with_overscan;
    vec2 param_16 = screen_coord_with_overscan;
    vec2 param_17 = screen_scale_with_overscan;
    vec2 _5325 = HSM_GetCrtShaderFinalCoordExtraVariables(param_11, param_12, param_13, param_14, param_15, param_16, param_17);
    ...
    vec2 screen_curved_coord_with_overscan_and_mirror = _5325;
    ...
    vec3 l3 = HSM_GetCroppedTexSample(LinearizePass, param_20).xyz;
    vec2 param_21 = pC4 - offx;
    vec3 l2 = HSM_GetCroppedTexSample(LinearizePass, param_21).xyz;
    vec2 param_22 = pC4;
    vec3 l1 = HSM_GetCroppedTexSample(LinearizePass, param_22).xyz;
    vec2 param_23 = pC4 + offx;
    vec3 r1 = HSM_GetCroppedTexSample(LinearizePass, param_23).xyz;
    vec2 param_24 = pC4 + off2;
    vec3 r2 = HSM_GetCroppedTexSample(LinearizePass, param_24).xyz;
    vec2 param_25 = (pC4 + offx) + off2;
    vec3 r3 = HSM_GetCroppedTexSample(LinearizePass, param_25).xyz;
    ...
    if (!interb)
    {
        ...
        vec3 param_52 = color1;
        vec3 param_53 = color2;
    ...
    {
        vec2 param_58 = TUBE_DIFFUSE_COORD;
        float param_59 = 1.0;
        vec2 param_60 = TUBE_DIFFUSE_SCALE;
        vec2 param_61 = TUBE_SCALE;
        float param_62 = TUBE_DIFFUSE_ASPECT;
        float param_63 = 1.0;
        vec2 tube_curved_coord = HSM_GetTubeCurvedCoord(param_58, param_59, param_60, param_61, param_62, param_63);
        vec4 param_64 = FragColor;
        vec2 param_65 = screen_scale_with_overscan;
        vec2 param_66 = screen_coord_with_overscan;
        vec2 param_67 = screen_curved_coord_with_overscan;
        vec2 param_68 = tube_curved_coord;
        float param_69 = global.HSM_FAKE_SCANLINE_OPACITY / 100.0;
        vec4 _6719 = HSM_ApplyScanlineMask(param_64, param_65, param_66, param_67, param_68, param_69);
        FragColor = _6719;
    }
}
