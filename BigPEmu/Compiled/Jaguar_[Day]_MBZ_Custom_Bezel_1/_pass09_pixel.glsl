...
void main()
{
    ...
    if (params.g_crtgamut == 3.0)
    {
        _2690 = vec2(0.4367980062961578369140625, 0.614777028560638427734375);
    }
    else
    {
        vec2 _2698;
        if (params.g_crtgamut == (-4.0))
        {
            _2698 = vec2(0.599002420902252197265625, 0.525101184844970703125);
        }
        else
        {
            _2698 = (params.g_crtgamut == (-3.0)) ? vec2(0.599002420902252197265625, 0.525101184844970703125) : vec2(0.595899999141693115234375, 0.522700011730194091796875);
        }
        _2690 = _2698;
    }
    vec2 UVmax = _2690;
    ...
    else
    {
        ...
        else
        {
            ...
            if (params.g_crtgamut == (-3.0))
            {
                ...
                float param_9 = 1.0;
                bool param_10 = false;
                vec3 _2759 = PCtoTV(param_5, param_6, param_7, param_8, param_9, param_10);
                _2745 = _2759;
            }
            else
            {
                ...
                if (params.g_crtgamut == (-4.0))
                {
                    ...
                    float param_15 = 1.0;
                    bool param_16 = false;
                    vec3 _2778 = PCtoTV(param_11, param_12, param_13, param_14, param_15, param_16);
                    _2764 = _2778;
                }
                else
                {
                    ...
                    float param_21 = 1.0;
                    bool param_22 = false;
                    vec3 _2791 = PCtoTV(param_17, param_18, param_19, param_20, param_21, param_22);
                    _2764 = _2791;
                }
                _2745 = _2764;
            }
    ...
    else
    {
        ...
        else
        {
            ...
            if (params.g_crtgamut == (-3.0))
            {
                ...
                float param_27 = 1.0;
                bool param_28 = false;
                vec3 _2893 = TVtoPC(param_23, param_24, param_25, param_26, param_27, param_28);
                _2879 = _2893;
            }
            else
            {
                ...
                if (params.g_crtgamut == (-4.0))
                {
                    ...
                    float param_33 = 1.0;
                    bool param_34 = false;
                    vec3 _2912 = TVtoPC(param_29, param_30, param_31, param_32, param_33, param_34);
                    _2898 = _2912;
                }
                else
                {
                    ...
                    float param_39 = 1.0;
                    bool param_40 = false;
                    vec3 _2925 = TVtoPC(param_35, param_36, param_37, param_38, param_39, param_40);
                    _2898 = _2925;
                }
                _2879 = _2898;
            }
    ...
    vec3 _3010 = moncurve_f_f3(param_48, param_49, param_50);
    col = _3010;
    mat3 m_in;
    if (params.g_crtgamut == (-4.0))
    {
    ...
    vec3 _3290 = moncurve_r_f3(param_69, param_70, param_71);
    adj = _3290;
    vec3 vcolor = adj;
    vec3 _3296;
    if (params.g_space_out == 3.0)
    {
        _3296 = clamp(pow(vcolor, vec3(2.19921875)), vec3(0.0), vec3(1.0));
    }
    else
    {
        vec3 _3310;
        if (params.g_space_out == 2.0)
        {
            ...
            vec3 _3319 = moncurve_f_f3(param_72, param_73, param_74);
            _3310 = _3319;
        }
        else
        {
            ...
            {
                _3324 = clamp(pow(vcolor, vec3(2.599999904632568359375)), vec3(0.0), vec3(1.0));
            }
            else
            {
                vec3 _3338;
                if (params.g_space_out == 0.0)
                {
                    ...
                    vec3 _3347 = moncurve_f_f3(param_75, param_76, param_77);
                    _3338 = _3347;
                }
                else
                {
                    _3338 = clamp(pow(pow(vcolor, vec3(0.9811000823974609375)), vec3(2.400000095367431640625)), vec3(0.0), vec3(1.0));
                }
                _3324 = _3338;
            }
            _3310 = _3324;
    ...
    float toGamma = clamp(_3378, 0.0, 1.0);
    float _3383;
    if (Yxy.x > 0.5)
    {
    ...
    vec3 contrast = vec3(_3427, Yxy.y, Yxy.z);
    ...
    vec4 _3478 = HSM_UpdateGlobalScreenValuesFromCache(InfoCachePass, param_102);
    ...
    if (params.g_space_out == 3.0)
    {
        _3559 = vec3(0.2973400056362152099609375, 0.62735998630523681640625, 0.075290001928806304931640625);
    }
    else
    {
        vec3 _3567;
        if (params.g_space_out == 2.0)
        {
            _3567 = vec3(0.2484013736248016357421875, 0.67799961566925048828125, 0.039131723344326019287109375);
        }
        else
        {
            _3567 = (params.g_space_out == 1.0) ? vec3(0.22898375988006591796875, 0.69173991680145263671875, 0.079276166856288909912109375) : vec3(0.21264933049678802490234375, 0.715169131755828857421875, 0.072181522846221923828125);
        }
        _3559 = _3567;
    }
    vec3 coeff = _3559;
    ...
    vec4 _3645 = rolled_gain_v4(param_103, param_104);
    screen = clamp(_3645, vec4(0.0), vec4(1.0));
    screen = color * screen;
    ...
    if (src_h.x >= 0.0)
    {
        _3675 = pow(src_h.x, 0.430000007152557373046875);
    }
    else
    {
        _3675 = -pow(-src_h.x, 0.430000007152557373046875);
    ...
    if (src_h.y >= 0.0)
    {
        _3693 = pow(src_h.y, 0.430000007152557373046875);
    }
    else
    {
        _3693 = -pow(-src_h.y, 0.430000007152557373046875);
    ...
    if (src_h.z >= 0.0)
    {
        _3710 = pow(src_h.z, 0.430000007152557373046875);
    }
    else
    {
        _3710 = -pow(-src_h.z, 0.430000007152557373046875);
    ...
    if (params.g_vibr < 0.0)
    {
        ...
        _3822 = 1.0 - (abs(SatMask(param_110, param_111, param_112) - 1.0) * abs(params.g_vibr));
    }
    else
    {
        ...
        _3822 = 1.0 - (SatMask(param_113, param_114, param_115) * params.g_vibr);
    }
    float sat_msk = _3822;
    ...
    if (params.g_space_out == 3.0)
    {
        _3875 = clamp(pow(src_h, vec3(0.4547069370746612548828125)), vec3(0.0), vec3(1.0));
    }
    else
    {
        vec3 _3889;
        if (params.g_space_out == 2.0)
        {
            ...
            vec3 _3896 = moncurve_r_f3(param_119, param_120, param_121);
            _3889 = _3896;
        }
        else
        {
            ...
            if (params.g_space_out == 1.0)
            {
                _3901 = clamp(pow(src_h, vec3(0.3846153914928436279296875)), vec3(0.0), vec3(1.0));
            }
            else
            {
                vec3 _3915;
                if (params.g_space_out == 0.0)
                {
                    ...
                    vec3 _3922 = moncurve_r_f3(param_122, param_123, param_124);
                    _3915 = _3922;
                }
                else
                {
                    _3915 = clamp(pow(pow(src_h, vec3(1.0192639827728271484375)), vec3(0.4166666567325592041015625)), vec3(0.0), vec3(1.0));
                }
                _3901 = _3915;
            }
            _3889 = _3901;
