...
void frag_main()
{
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    float3 param_3 = src;
                    _2672 = RGB_FCC(param_3);
                }
                else
                {
                    float3 param_4 = src;
                    _2672 = RGB_YIQ(param_4);
                }
                _2661 = _2672;
            }
            _2651 = _2661;
    ...
    if (params_g_crtgamut == 3.0f)
    {
        _2690 = float2(0.4367980062961578369140625f, 0.614777028560638427734375f);
    }
    else
    {
        float2 _2698;
        if (params_g_crtgamut == (-4.0f))
        {
            _2698 = float2(0.599002420902252197265625f, 0.525101184844970703125f);
        }
        else
        {
            _2698 = (params_g_crtgamut == (-3.0f)) ? float2(0.599002420902252197265625f, 0.525101184844970703125f) : float2(0.595899999141693115234375f, 0.522700011730194091796875f);
        }
        _2690 = _2698;
    }
    float2 UVmax = _2690;
    ...
    else
    {
        ...
        else
        {
            ...
            if (params_g_crtgamut == (-3.0f))
            {
                ...
                float param_9 = 1.0f;
                bool param_10 = false;
                float3 _2759 = PCtoTV(param_5, param_6, param_7, param_8, param_9, param_10);
                _2745 = _2759;
            }
            else
            {
                ...
                if (params_g_crtgamut == (-4.0f))
                {
                    ...
                    float param_15 = 1.0f;
                    bool param_16 = false;
                    float3 _2778 = PCtoTV(param_11, param_12, param_13, param_14, param_15, param_16);
                    _2764 = _2778;
                }
                else
                {
                    ...
                    float param_21 = 1.0f;
                    bool param_22 = false;
                    float3 _2791 = PCtoTV(param_17, param_18, param_19, param_20, param_21, param_22);
                    _2764 = _2791;
                }
                _2745 = _2764;
            }
    ...
    else
    {
        ...
        else
        {
            ...
            if (params_g_crtgamut == (-3.0f))
            {
                ...
                float param_27 = 1.0f;
                bool param_28 = false;
                float3 _2893 = TVtoPC(param_23, param_24, param_25, param_26, param_27, param_28);
                _2879 = _2893;
            }
            else
            {
                ...
                if (params_g_crtgamut == (-4.0f))
                {
                    ...
                    float param_33 = 1.0f;
                    bool param_34 = false;
                    float3 _2912 = TVtoPC(param_29, param_30, param_31, param_32, param_33, param_34);
                    _2898 = _2912;
                }
                else
                {
                    ...
                    float param_39 = 1.0f;
                    bool param_40 = false;
                    float3 _2925 = TVtoPC(param_35, param_36, param_37, param_38, param_39, param_40);
                    _2898 = _2925;
                }
                _2879 = _2898;
            }
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    float3 param_44 = col;
                    _2963 = FCC_RGB(param_44);
                }
                else
                {
                    float3 param_45 = col;
                    _2963 = YIQ_RGB(param_45);
                }
                _2953 = _2963;
            }
            _2943 = _2953;
    ...
    if (params_g_crtgamut == (-4.0f))
    {
        ...
        _3153 = wp_adjust(param_51, param_52);
    }
    else
    {
        float3 _3169;
        if (params_g_crtgamut == (-3.0f))
        {
            ...
            _3169 = wp_adjust(param_53, param_54);
        }
        else
        {
            float3 _3183;
            if (params_g_crtgamut == (-2.0f))
            {
                ...
                _3183 = wp_adjust(param_55, param_56);
            }
            else
            {
                float3 _3198;
                if (params_g_crtgamut == (-1.0f))
                {
                    ...
                    _3198 = wp_adjust(param_57, param_58);
                }
                else
                {
                    float3 _3212;
                    if (params_g_crtgamut == 1.0f)
                    {
                        ...
                        _3212 = wp_adjust(param_59, param_60);
                    }
                    else
                    {
                        float3 _3226;
                        if (params_g_crtgamut == 2.0f)
                        {
                            ...
                            _3226 = wp_adjust(param_61, param_62);
                        }
                        else
                        {
                            float3 _3241;
                            if (params_g_crtgamut == 3.0f)
                            {
                                ...
                                _3241 = wp_adjust(param_63, param_64);
                            }
                            else
                            {
                                float param_65 = global_wp_temperature;
                                float3 param_66 = gamut;
                                _3241 = wp_adjust(param_65, param_66);
                            }
                            _3226 = _3241;
                        }
                        _3212 = _3226;
    ...
    float3 _3290 = moncurve_r_f3(param_69, param_70, param_71);
    adj = _3290;
    float3 vcolor = adj;
    float3 _3296;
    if (params_g_space_out == 3.0f)
    {
        _3296 = clamp(pow(vcolor, 2.19921875f.xxx), 0.0f.xxx, 1.0f.xxx);
    }
    else
    {
        float3 _3310;
        if (params_g_space_out == 2.0f)
        {
            ...
            float3 _3319 = moncurve_f_f3(param_72, param_73, param_74);
            _3310 = _3319;
        }
        else
        {
            ...
            {
                _3324 = clamp(pow(vcolor, 2.599999904632568359375f.xxx), 0.0f.xxx, 1.0f.xxx);
            }
            else
            {
                float3 _3338;
                if (params_g_space_out == 0.0f)
                {
                    ...
                    float3 _3347 = moncurve_f_f3(param_75, param_76, param_77);
                    _3338 = _3347;
                }
                else
                {
                    _3338 = clamp(pow(pow(vcolor, 0.9811000823974609375f.xxx), 2.400000095367431640625f.xxx), 0.0f.xxx, 1.0f.xxx);
                }
                _3324 = _3338;
            }
            _3310 = _3324;
    ...
    float _3378 = moncurve_r(param_81, param_82, param_83);
    float toGamma = clamp(_3378, 0.0f, 1.0f);
    float _3383;
    if (Yxy.x > 0.5f)
    {
        ...
        float param_86 = 0.5f;
        float _3391 = contrast_sigmoid_inv(param_84, param_85, param_86);
        _3383 = _3391;
    }
    else
    {
    ...
    if (params_g_cntrst > 0.0f)
    {
        ...
        float _3410 = contrast_sigmoid(param_87, param_88, param_89);
        _3399 = _3410;
    }
    else
    {
        ...
        float _3420 = contrast_sigmoid_inv(param_90, param_91, param_92);
        _3399 = _3420;
    }
    float sigmoid = _3399;
    ...
    float _3427 = moncurve_f(param_93, param_94, param_95);
    float3 contrast = float3(_3427, Yxy.y, Yxy.z);
    ...
    if (params_g_cntrst == 0.0f)
    {
        ...
        _3448 = XYZ_to_RGB(param_99, param_100);
    }
    else
    {
        _3448 = XYZsrgb;
    ...
    float4 _3478 = HSM_UpdateGlobalScreenValuesFromCache(InfoCachePass, _InfoCachePass_sampler, param_102);
    ...
    if (params_g_space_out == 3.0f)
    {
        _3559 = float3(0.2973400056362152099609375f, 0.62735998630523681640625f, 0.075290001928806304931640625f);
    }
    else
    {
        float3 _3567;
        if (params_g_space_out == 2.0f)
        {
            _3567 = float3(0.2484013736248016357421875f, 0.67799961566925048828125f, 0.039131723344326019287109375f);
        }
        else
        {
            _3567 = (params_g_space_out == 1.0f) ? float3(0.22898375988006591796875f, 0.69173991680145263671875f, 0.079276166856288909912109375f) : float3(0.21264933049678802490234375f, 0.715169131755828857421875f, 0.072181522846221923828125f);
        }
        _3559 = _3567;
    }
    float3 coeff = _3559;
    ...
    float4 _3645 = rolled_gain_v4(param_103, param_104);
    screen = clamp(_3645, 0.0f.xxxx, 1.0f.xxxx);
    ...
    if (src_h.x >= 0.0f)
    {
        _3675 = pow(src_h.x, 0.430000007152557373046875f);
    }
    else
    {
        _3675 = -pow(-src_h.x, 0.430000007152557373046875f);
    ...
    if (src_h.y >= 0.0f)
    {
        _3693 = pow(src_h.y, 0.430000007152557373046875f);
    }
    else
    {
        _3693 = -pow(-src_h.y, 0.430000007152557373046875f);
    ...
    if (src_h.z >= 0.0f)
    {
        _3710 = pow(src_h.z, 0.430000007152557373046875f);
    }
    else
    {
        _3710 = -pow(-src_h.z, 0.430000007152557373046875f);
    ...
    if (params_g_vibr < 0.0f)
    {
        ...
        _3822 = 1.0f - (abs(SatMask(param_110, param_111, param_112) - 1.0f) * abs(params_g_vibr));
    }
    else
    {
        ...
        _3822 = 1.0f - (SatMask(param_113, param_114, param_115) * params_g_vibr);
    }
    float sat_msk = _3822;
    ...
    if (params_g_space_out == 3.0f)
    {
        _3875 = clamp(pow(src_h, 0.4547069370746612548828125f.xxx), 0.0f.xxx, 1.0f.xxx);
    }
    else
    {
        float3 _3889;
        if (params_g_space_out == 2.0f)
        {
            ...
            float3 _3896 = moncurve_r_f3(param_119, param_120, param_121);
            _3889 = _3896;
        }
        else
        {
            ...
            if (params_g_space_out == 1.0f)
            {
                _3901 = clamp(pow(src_h, 0.3846153914928436279296875f.xxx), 0.0f.xxx, 1.0f.xxx);
            }
            else
            {
                float3 _3915;
                if (params_g_space_out == 0.0f)
                {
                    ...
                    float3 _3922 = moncurve_r_f3(param_122, param_123, param_124);
                    _3915 = _3922;
                }
                else
                {
                    _3915 = clamp(pow(pow(src_h, 1.0192639827728271484375f.xxx), 0.4166666567325592041015625f.xxx), 0.0f.xxx, 1.0f.xxx);
                }
                _3901 = _3915;
            }
            _3889 = _3901;
