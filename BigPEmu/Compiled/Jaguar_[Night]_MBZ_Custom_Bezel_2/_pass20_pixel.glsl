...
bool HSM_GetIsInABCompareArea(vec2 viewport_coord)
{
    ...
    {
        _6522 = 1.0 - HSM_AB_COMPARE_SPLIT_POSITION;
    }
    else
    {
    ...
    bool _6536 = (mod(HSM_AB_COMPARE_AREA, 2.0) == 0.0) && (test_value < position);
    bool _6547;
    if (!_6536)
    {
        _6547 = (mod(HSM_AB_COMPARE_AREA, 2.0) == 1.0) && (test_value > position);
    }
    else
    {
        _6547 = _6536;
...
{
    bool _3053 = abs(in_coord.x - 0.5) > 0.500999987125396728515625;
    bool _3062;
    if (!_3053)
    {
        _3062 = abs(in_coord.y - 0.5) > 0.500999987125396728515625;
    }
    else
    {
        _3062 = _3053;
...
vec2 HSM_GetGeomCurvedCoord(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, inout float in_distance, float in_aspect)
{
    ...
    vec2 _5661 = transform(param_5, param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 curved_coord = _5661;
    return curved_coord;
}
...
vec2 HSM_GetGeomCurvedCoordRetainWidth(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, float in_distance, float in_aspect)
{
    ...
    vec2 _5678 = HSM_GetGeomCurvedCoord(param, param_1, param_2, param_3, param_4, param_5);
    vec2 ctr_curved_coord = _5678 - vec2(0.5);
    ...
    vec2 _5693 = HSM_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 right_edge_curved_ctr_coord = _5693 - vec2(0.5);
...
vec3 hrg_get_ideal_global_eye_pos_for_points(inout vec3 eye_pos, vec2 output_aspect, vec3 global_coords[9], int num_points, float in_geom_radius, float in_geom_view_dist)
{
    ...
    for (int iter = 0; iter < max_centering_iters; iter++)
    {
        ...
        vec3 _4071 = eye_pos;
        vec2 _4073 = _4071.xy + center_offset;
        eye_pos.x = _4073.x;
        eye_pos.y = _4073.y;
...
vec3 hrg_get_ideal_global_eye_pos(mat3 local_to_global, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist)
{
    ...
    if (in_geom_mode < 2.5)
    {
        _4232 = vec3(0.0, 0.0, eye_z_spherical);
    }
    else
    {
        _4232 = vec3(0.0, 0.0, max(in_geom_view_dist, eye_z_spherical));
    }
    vec3 eye_pos = _4232;
    int num_points = 9;
    vec2 param = vec2(0.0);
    ...
    else
    {
        ...
        vec3 _4391 = hrg_get_ideal_global_eye_pos_for_points(param_36, param_37, param_38, param_39, param_40, param_41);
        _4374 = _4391;
    }
    return _4374;
}
...
vec2 hrg_get_curved_video_uv_coords_and_tangent_matrix(vec2 flat_video_uv, vec3 eye_pos_local, vec2 output_pixel_size, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, mat3 global_to_local, out mat2 pixel_to_tangent_video_uv)
{
    ...
    vec3 param_5;
    vec2 _4616 = hrg_view_vec_to_uv(param, param_1, param_2, param_3, param_4, param_5);
    vec3 pos = param_5;
    vec2 centered_uv = _4616;
    ...
    if (geom_force_correct_tangent_matrix)
    {
        ...
        {
            _4628 = vec3(pos.x, 0.0, pos.z);
        }
        vec3 normal_base = _4628;
...
vec2 HRG_GetGeomCurvedCoord(vec2 in_coord, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, float in_geom_tilt_angle_x, float in_geom_tilt_angle_y, float in_screen_aspect, float pin_inner_edge, vec2 in_source_size, vec2 in_output_size, out mat2 pixel_to_video_uv)
{
    ...
    if (in_geom_mode > 0.5)
    {
        ...
        mat2 param_14;
        vec2 _4796 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14);
        pixel_to_video_uv = param_14;
        vec2 ctr_curved_coord = _4796 - vec2(0.5);
        if ((in_geom_tilt_angle_x == 0.0) && (in_geom_tilt_angle_y == 0.0))
        {
            ...
            mat2 param_23;
            vec2 _4825 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_15, param_16, param_17, param_18, param_19, param_20, param_21, param_22, param_23);
            pixel_to_video_uv = param_23;
            vec2 right_edge_curved_ctr_coord = _4825 - vec2(0.5);
            ...
            mat2 param_32;
            vec2 _4847 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_24, param_25, param_26, param_27, param_28, param_29, param_30, param_31, param_32);
            pixel_to_video_uv = param_32;
            vec2 bottom_edge_curved_ctr_coord = _4847 - vec2(0.5);
            ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
        ...
        if (pin_inner_edge == 1.0)
        {
            if (in_geom_tilt_angle_y != 0.0)
            {
                ...
                mat2 param_41;
                vec2 _4890 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_33, param_34, param_35, param_36, param_37, param_38, param_39, param_40, param_41);
                pixel_to_video_uv = param_41;
                vec2 top_edge_curved_ctr_coord = _4890;
            ...
            if (in_geom_tilt_angle_x != 0.0)
            {
                ...
                mat2 param_50;
                vec2 _4919 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_42, param_43, param_44, param_45, param_46, param_47, param_48, param_49, param_50);
                pixel_to_video_uv = param_50;
                vec2 left_edge_curved_ctr_coord = _4919;
...
vec2 HSM_GetCurvatureValues(float screen_aspect)
{
    ...
    {
        _5222 = vec2((((2.0 * global.HSM_CURVATURE_2D_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0, ((global.HSM_CURVATURE_2D_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0);
    }
    else
    {
        _5222 = vec2(((global.HSM_CURVATURE_2D_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0, (((2.0 * global.HSM_CURVATURE_2D_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0);
    }
    vec2 curvature_values = _5222;
...
vec2 HSM_Get2DCurvedCoord(vec2 in_coord, vec2 curvature_values)
{
    ...
    vec2 _5757 = HSM_GetCrtPiCurvedCoord(param, param_1);
    ctr_curved_coord = _5757 - vec2(0.5);
    vec2 param_2 = vec2(1.0, 0.5);
    vec2 param_3 = curvature_values;
    vec2 _5764 = HSM_GetCrtPiCurvedCoord(param_2, param_3);
    vec2 right_edge_curved_ctr_coord = _5764 - vec2(0.5);
    ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
    vec2 param_4 = vec2(0.5, 1.0);
    vec2 param_5 = curvature_values;
    vec2 _5778 = HSM_GetCrtPiCurvedCoord(param_4, param_5);
    vec2 bottom_edge_curved_ctr_coord = _5778 - vec2(0.5);
    ctr_curved_coord.y = (ctr_curved_coord.y * 0.5) / bottom_edge_curved_ctr_coord.y;
    return ctr_curved_coord + vec2(0.5);
}
...
vec2 HSM_GetCurvedCoord(vec2 in_coord, float curvature_multiplier, float screen_aspect)
{
    ...
    if (HSM_CURVATURE_MODE > CURVATURE_MODE_2D_CYLINDER)
    {
        ...
        else
        {
            ...
            mat2 param_16;
            vec2 _5885 = HRG_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16);
...
vec2 HSM_GetTubeCurvedCoord(vec2 screen_coord, float curvature_scale, vec2 screen_scale, vec2 tube_scale, float screen_aspect, float apply_black_edge_offset)
{
    ...
    if (global.HSM_BZL_USE_INDEPENDENT_CURVATURE == 1.0)
    {
        ...
        if (screen_aspect < 1.0)
        {
            _6042 = vec2((((2.0 * global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0, ((global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0);
        }
        else
        {
            _6042 = vec2(((global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0, (((2.0 * global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0);
        }
        vec2 curvature_values = _6042;
...
float HSM_GetBezelCoords(vec2 tube_diffuse_coord, vec2 tube_diffuse_scale, vec2 tube_scale, float screen_aspect, bool curve_coords_on, out vec2 bezel_outside_scale, inout vec2 bezel_outside_coord, inout vec2 bezel_outside_curved_coord, inout vec2 frame_outside_curved_coord)
{
    ...
    if (curve_coords_on)
    {
        bool _7359 = HSM_CURVATURE_MODE > 0.0;
        bool _7367;
        if (_7359)
        {
            _7367 = (HSM_CURVATURE_3D_TILT_ANGLE_X != 0.0) || (HSM_CURVATURE_3D_TILT_ANGLE_Y != 0.0);
        }
        else
        {
            _7367 = _7359;
...
vec3 HSM_RGBtoHSV(vec3 c)
{
    ...
    if (c.y < c.z)
    {
        _2673 = vec4(c.zy, K.wz);
    }
    else
    {
        _2673 = vec4(c.yz, K.xy);
    }
    vec4 p = _2673;
    vec4 _2703;
    if (c.x < p.x)
    {
        _2703 = vec4(p.xyw, c.x);
    }
    else
    {
        _2703 = vec4(c.x, p.yzx);
    }
    vec4 q = _2703;
...
vec4 HSM_ApplyMonochrome(vec4 in_color)
{
    ...
    vec4 _6847 = out_color;
    vec3 _6853 = pow(_6847.xyz, vec3(global.HSM_MONOCHROME_GAMMA));
    out_color.x = _6853.x;
    out_color.y = _6853.y;
    out_color.z = _6853.z;
    ...
    bool _6893 = (global.HSM_MONOCHROME_HUE_OFFSET / 360.0) != 0.0;
    bool _6902;
    if (!_6893)
    {
        _6902 = (global.HSM_MONOCHROME_SATURATION / 100.0) != 0.0;
    }
    else
    {
        _6902 = _6893;
    ...
    vec3 _6932 = mcolor * pow(luma, 1.0 / global.HSM_MONOCHROME_GAMMA);
    out_color.x = _6932.x;
    out_color.y = _6932.y;
    out_color.z = _6932.z;
    return out_color;
...
vec2 HSM_GetMirrorWrappedCoord(inout vec2 in_coord)
{
    ...
    bool _5909 = abs(ctr_coord.x) > 0.5;
    bool _5917;
    if (!_5909)
    {
        _5917 = abs(ctr_coord.y) > 0.5;
    }
    else
    {
        _5917 = _5909;
...
{
    vec2 param = in_coord;
    vec2 _6588 = HSM_GetMirrorWrappedCoord(param);
    vec2 vpos = _6588;
...
{
    bool _6637 = global.HSM_SCREEN_VIGNETTE_ON > 0.5;
    bool _6643;
    if (_6637)
    {
...
vec4 HSM_GetCroppedTexSample(sampler2D in_sampler, vec2 in_screen_coord)
{
    ...
    vec4 _6582 = HSM_GetTexSampleFromSampleStartAndSize(in_sampler, param, param_1, param_2);
    return _6582;
}
...
vec2 GetSimpleImageScaledCoord(inout vec2 in_viewport_coord, vec2 in_viewport_unscaled_coord, vec2 in_tube_coord, vec2 in_tube_scale, sampler2D in_sampler, vec2 in_pos, float in_inherit_pos, vec2 in_scale, float in_scale_inherit_mode, float in_keep_aspect, float in_mirror_horz, float in_rotate)
{
    ...
    if (in_rotate > 0.5)
    {
        _5184 = global.FinalViewportSize.x / global.FinalViewportSize.y;
    }
    else
    {
        _5184 = 1.0;
    }
    coord_ctr /= vec2(_5184);
    if (in_rotate > 0.5)
    {
...
vec4 HSM_GetNightLightingMultiplyColor(vec2 in_coord, float hue, float saturation, float value, float contrast, float global_ambient_opacity, sampler2D NightLightingImage_1)
{
    ...
    vec4 _6704 = lighting_image;
    vec3 _6708 = mix(vec3(1.0), _6704.xyz, vec3(global_ambient_opacity));
...
bool HSM_Fill_Ambient_Images(vec2 in_viewport_coord, vec2 in_viewport_unscaled_coord, vec2 in_tube_coord, vec2 in_tube_scale, float in_swap_images, sampler2D in_ambient_sampler, sampler2D in_ambient2_sampler, out vec4 ambient_lighting_image, out vec4 ambient2_lighting_image)
{
    ...
    if (HSM_AMBIENT1_OPACITY > 0.0)
    {
        ...
        bool _6726 = HSM_AMBIENT1_SCALE_INHERIT_MODE == 1.0;
        bool _6733;
        if (_6726)
        {
            _6733 = (HSM_AMBIENT1_SCALE * HSM_VIEWPORT_ZOOM) < 1.0;
        }
        else
        {
            _6733 = _6726;
        ...
        vec2 _6767 = GetSimpleImageScaledCoord(param, param_1, param_2, param_3, in_ambient_sampler, param_4, param_5, param_6, param_7, param_8, param_9, param_10);
        vec2 lighting_coord = _6767;
    ...
    if (HSM_AMBIENT2_OPACITY > 0.0)
    {
        ...
        bool _6788 = HSM_AMBIENT2_SCALE_INHERIT_MODE == 1.0;
        bool _6795;
        if (_6788)
        {
            _6795 = (HSM_AMBIENT2_SCALE * HSM_VIEWPORT_ZOOM) < 1.0;
        }
        else
        {
            _6795 = _6788;
        ...
        vec2 _6829 = GetSimpleImageScaledCoord(param_17, param_18, param_19, param_20, in_ambient2_sampler, param_21, param_22, param_23, param_24, param_25, param_26, param_27);
        vec2 lighting2_coord = _6829;
...
{
    bool _7510 = HSM_TUBE_DIFFUSE_MODE == 1.0;
    bool _7516;
    if (_7510)
    {
...
{
    bool _7520 = HSM_TUBE_COLORED_GEL_IMAGE_ON > 0.5;
    bool _7526;
    if (_7520)
    {
...
{
    bool _7500 = HSM_TUBE_STATIC_REFLECTION_IMAGE_ON > 0.5;
    bool _7506;
    if (_7500)
    {
...
vec4 HSM_GetPreMultipliedColorLinear(vec4 in_color, float matte_type, float encoded_gamma)
{
    ...
    {
        vec4 _2879 = out_color;
        float _2882 = out_color.w;
        vec3 _2888 = clamp(_2879.xyz - vec3(1.0 - _2882), vec3(0.0), vec3(1.0));
        out_color.x = _2888.x;
        out_color.y = _2888.y;
        out_color.z = _2888.z;
    }
    ...
    if (matte_type == SOURCE_MATTE_NONE)
    {
        ...
        vec4 _2907 = out_color;
        vec3 _2909 = _2907.xyz * _2906;
        out_color.x = _2909.x;
        out_color.y = _2909.y;
        out_color.z = _2909.z;
    }
...
vec4 HSM_BlendModeLayerMix(vec4 color_under, inout vec4 color_over, float blend_mode, float layer_opacity)
{
    ...
    if (blend_mode == BLEND_MODE_NORMAL)
    {
        ...
        vec4 _2969 = color_over;
        vec3 _2971 = _2969.xyz * _2968;
    ...
    else
    {
        ...
        {
            vec3 _2995 = color_under.xyz + color_over.xyz;
        ...
        {
            vec3 _3011 = color_under.xyz * color_over.xyz;
...
vec4 HSM_ApplyScanlineMask(vec4 in_color, vec2 screen_scale, inout vec2 in_coord, vec2 in_screen_curved_coord, vec2 in_tube_curved_coord, float in_scanline_opacity)
{
    ...
    {
        _7046 = global.HSM_FAKE_SCANLINE_RES;
    }
    else
    {
...
vec4 HSM_GetTubeHighlight(inout vec2 tube_curved_coord, bool apply_to_mirror, sampler2D TubeStaticReflectionImage_1)
{
    ...
    if (apply_to_mirror)
    {
        ...
        vec2 _7540 = HSM_GetMirrorWrappedCoord(param_1);
    ...
    vec4 _7641 = out_color;
    vec3 _7643 = _7641.xyz * HSM_GLOBAL_GRAPHICS_BRIGHTNESS;
    out_color.x = _7643.x;
    out_color.y = _7643.y;
    out_color.z = _7643.z;
    return out_color;
...
vec4 HSM_Apply_Sinden_Lightgun_Border(vec4 in_rgba, vec2 in_tube_diffuse_curved_coord, float in_tube_diffuse_mask, float in_black_edge_corner_radius)
{
    ...
    vec4 _7218 = out_rgba;
    vec3 _7221 = ((base_rgb * HSM_SINDEN_BORDER_BRIGHTNESS) * sinden_gun_mask) + (_7218.xyz * (1.0 - sinden_gun_mask));
    out_rgba.x = _7221.x;
    out_rgba.y = _7221.y;
    out_rgba.z = _7221.z;
    return out_rgba;
...
{
    bool _7655 = global.HSM_MONOCHROME_MODE > 0.5;
    bool _7661;
    if (_7655)
    {
    ...
    vec2 _7677 = HSM_GetMirrorWrappedCoord(param_2);
    vec2 mirrored_screen_coord = _7677;
    vec4 out_color = vec4(0.0);
    ...
    vec2 _7715 = HSM_GetMirrorWrappedCoord(param_13);
    vec2 mirrored_tube_coord = _7715;
    ...
    bool _7748 = HSM_AB_COMPARE_SHOW_MODE == 1.0;
    bool _7754;
    if (_7748)
    {
    ...
    if (_7754)
    {
        ...
        vec2 _7768 = HSM_GetMirrorWrappedCoord(param_16);
    ...
    vec4 _7846 = crt_color;
    vec3 _7848 = _7846.xyz * screen_to_tube_mask_invert;
    crt_color.x = _7848.x;
    crt_color.y = _7848.y;
    crt_color.z = _7848.z;
    ...
    bool _7871 = HSM_Fill_Ambient_Images(param_34, param_35, param_36, param_37, param_38, NightLightingImage_1, NightLighting2Image_1, param_39, param_40);
    ambient_lighting_image = param_39;
    ambient2_lighting_image = param_40;
    vec3 tube_shadow = vec3(1.0);
    bool _7876 = HSM_TUBE_SHADOW_IMAGE_ON > 0.5;
    bool _7890;
    if (_7876)
    {
    ...
    if (_7890)
    {
        ...
        vec2 _7897 = HSM_GetMirrorWrappedCoord(param_41);
        shadow_coord = _7897;
    ...
    {
        bool _7990 = adjusted_tube_diffuse_amount > 0.0;
        bool _7997;
        if (!_7990)
        {
            _7997 = global.HSM_CRT_BLEND_MODE == 2.0;
        }
        else
        {
            _7997 = _7990;
        ...
        if (_7997)
        {
            ...
            vec2 _8004 = HSM_GetMirrorWrappedCoord(param_51);
            diffuse_coord = _8004;
            ...
            vec3 _8054 = HSM_GetPreMultipliedColorLinear(param_57, param_58, param_59).xyz * HSM_GLOBAL_GRAPHICS_BRIGHTNESS;
            ...
            vec3 _8074 = HSM_ApplyHSVAdjustment(param_60, param_61, param_62, param_63, param_64, param_65);
            tube_diffuse.x = _8074.x;
            tube_diffuse.y = _8074.y;
            tube_diffuse.z = _8074.z;
            vec4 _8082 = tube_diffuse;
            vec3 _8084 = _8082.xyz * HSM_TUBE_DIFFUSE_IMAGE_AMOUNT;
            tube_diffuse.x = _8084.x;
            tube_diffuse.y = _8084.y;
            tube_diffuse.z = _8084.z;
            vec4 _8092 = tube_diffuse;
            vec3 _8094 = _8092.xyz * tube_shadow;
        ...
        vec3 _8109 = HSM_ApplyAmbientImage(param_66, param_67, param_68);
        ...
        vec3 _8124 = HSM_ApplyAmbientImage(param_69, param_70, param_71);
    ...
    vec4 _8142 = out_color;
    vec3 _8144 = _8142.xyz + crt_color.xyz;
    out_color.x = _8144.x;
    out_color.y = _8144.y;
    out_color.z = _8144.z;
    ...
    {
        vec4 _8164 = out_color;
        vec3 _8166 = _8164.xyz + tube_diffuse.xyz;
        out_color.x = _8166.x;
        out_color.y = _8166.y;
        out_color.z = _8166.z;
    }
    if (global.HSM_CRT_BLEND_MODE == 2.0)
    {
        ...
        vec4 _8193 = HSM_BlendModeLayerMix(param_72, param_73, param_74, param_75);
        out_color = _8193;
    }
    if (HSM_GetUseTubeColoredGelImage())
    {
        vec2 param_76 = tube_diffuse_curved_coord;
        vec2 _8200 = HSM_GetMirrorWrappedCoord(param_76);
        vec2 gel_coord = _8200;
        ...
        {
            vec4 _8240 = out_color;
            vec4 _8242 = out_color;
            vec3 _8249 = mix(_8240.xyz, _8242.xyz * gel_image.xyz, vec3(HSM_TUBE_COLORED_GEL_IMAGE_MULTIPLY_AMOUNT));
            out_color.x = _8249.x;
            out_color.y = _8249.y;
            out_color.z = _8249.z;
        }
        ...
        {
            vec4 _8260 = out_color;
            vec4 _8262 = out_color;
            vec3 _8269 = mix(_8260.xyz, _8262.xyz + gel_image.xyz, vec3(HSM_TUBE_COLORED_GEL_IMAGE_ADDITIVE_AMOUNT));
            out_color.x = _8269.x;
            out_color.y = _8269.y;
            out_color.z = _8269.z;
        }
        if (HSM_TUBE_COLORED_GEL_IMAGE_NORMAL_AMOUNT > 0.0)
        {
            ...
            vec4 _8290 = gel_image;
            vec3 _8292 = _8290.xyz * HSM_TUBE_COLORED_GEL_IMAGE_NORMAL_BRIGHTNESS;
            gel_image.x = _8292.x;
            gel_image.y = _8292.y;
            gel_image.z = _8292.z;
            vec4 _8300 = gel_image;
            vec3 _8302 = _8300.xyz * tube_shadow;
            gel_image.x = _8302.x;
            gel_image.y = _8302.y;
            gel_image.z = _8302.z;
            if (HSM_TUBE_COLORED_GEL_IMAGE_FAKE_SCANLINE_AMOUNT > 0.001000000047497451305389404296875)
            {
                ...
                vec4 _8325 = HSM_ApplyScanlineMask(param_82, param_83, param_84, param_85, param_86, param_87);
            ...
            vec3 _8341 = HSM_ApplyAmbientImage(param_88, param_89, param_90);
            gel_image.x = _8341.x;
            gel_image.y = _8341.y;
            gel_image.z = _8341.z;
            ...
            vec3 _8356 = HSM_ApplyAmbientImage(param_91, param_92, param_93);
            gel_image.x = _8356.x;
            gel_image.y = _8356.y;
            gel_image.z = _8356.z;
            ...
            vec4 _8376 = HSM_BlendModeLayerMix(param_94, param_95, param_96, param_97);
            gel_image = _8376;
            if (HSM_SHOW_CRT_ON_TOP_OF_COLORED_GEL == 0.0)
            {
                ...
                vec4 _8389 = HSM_BlendModeLayerMix(param_98, param_99, param_100, param_101);
                out_color = _8389;
            }
            if (HSM_SHOW_CRT_ON_TOP_OF_COLORED_GEL == 1.0)
            {
                vec4 _8395 = gel_image;
                vec3 _8397 = _8395.xyz * tube_shadow;
                gel_image.x = _8397.x;
                gel_image.y = _8397.y;
                gel_image.z = _8397.z;
                ...
                vec4 _8413 = HSM_BlendModeLayerMix(param_102, param_103, param_104, param_105);
                vec4 normal_blended = _8413;
                out_color = normal_blended + out_color;
            }
        }
    }
    vec4 _8418 = out_color;
    vec3 _8420 = _8418.xyz * black_edge_mask_invert;
    out_color.x = _8420.x;
    out_color.y = _8420.y;
    out_color.z = _8420.z;
    if (HSM_GetUseTubeStaticReflection())
    {
        ...
        vec4 _8434 = HSM_GetTubeHighlight(param_106, param_107, TubeStaticReflectionImage_1);
        vec3 tube_highlight_image = _8434.xyz;
        ...
        vec4 _8482 = out_color;
        vec3 _8484 = _8482.xyz + (tube_highlight_image * HSM_TUBE_STATIC_REFLECTION_IMAGE_OPACITY);
        out_color.x = _8484.x;
        out_color.y = _8484.y;
        out_color.z = _8484.z;
    }
...
void main()
{
    ...
    bool _8508 = HSM_AB_COMPARE_FREEZE_CRT_TUBE == 1.0;
    bool _8516;
    if (_8508)
    {
    ...
    vec4 _8536 = HSM_UpdateGlobalScreenValuesFromCache(InfoCachePass, param_3);
    ...
    vec4 _8616 = HSM_GetPostCrtPreppedColor(param_23, param_24, param_25, DerezedPass, TubeDiffuseImage, TubeColoredGelImage, TubeStaticReflectionImage, BackgroundImage, BackgroundVertImage, NightLightingImage, NightLighting2Image);
    FragColor = _8616;
}
