...
vec4 HSM_GetNightLightingMultiplyColor(vec2 in_coord, float hue, float saturation, float value, float contrast, float global_ambient_opacity, sampler2D NightLightingImage_1)
{
    ...
    vec4 _6266 = lighting_image;
    vec3 _6270 = mix(vec3(1.0), _6266.xyz, vec3(global_ambient_opacity));
...
bool HSM_Fill_Ambient_Images(vec2 in_viewport_coord, vec2 in_viewport_unscaled_coord, vec2 in_tube_coord, vec2 in_tube_scale, float in_swap_images, sampler2D in_ambient_sampler, sampler2D in_ambient2_sampler, out vec4 ambient_lighting_image, out vec4 ambient2_lighting_image)
{
    ...
    if (HSM_AMBIENT1_OPACITY > 0.0)
    {
        ...
        vec2 _6329 = GetSimpleImageScaledCoord(param, param_1, param_2, param_3, in_ambient_sampler, param_4, param_5, param_6, param_7, param_8, param_9, param_10);
        vec2 lighting_coord = _6329;
    ...
    if (HSM_AMBIENT2_OPACITY > 0.0)
    {
        ...
        vec2 _6391 = GetSimpleImageScaledCoord(param_17, param_18, param_19, param_20, in_ambient2_sampler, param_21, param_22, param_23, param_24, param_25, param_26, param_27);
        vec2 lighting2_coord = _6391;
...
vec2 HSM_GetGeomCurvedCoord(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, inout float in_distance, float in_aspect)
{
    ...
    vec2 _5658 = transform(param_5, param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 curved_coord = _5658;
    return curved_coord;
}
...
vec2 HSM_GetGeomCurvedCoordRetainWidth(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, float in_distance, float in_aspect)
{
    ...
    vec2 _5675 = HSM_GetGeomCurvedCoord(param, param_1, param_2, param_3, param_4, param_5);
    vec2 ctr_curved_coord = _5675 - vec2(0.5);
    ...
    vec2 _5690 = HSM_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 right_edge_curved_ctr_coord = _5690 - vec2(0.5);
...
vec3 hrg_get_ideal_global_eye_pos_for_points(inout vec3 eye_pos, vec2 output_aspect, vec3 global_coords[9], int num_points, float in_geom_radius, float in_geom_view_dist)
{
    ...
    for (int iter = 0; iter < max_centering_iters; iter++)
    {
        ...
        vec3 _4087 = eye_pos;
        vec2 _4089 = _4087.xy + center_offset;
        eye_pos.x = _4089.x;
        eye_pos.y = _4089.y;
...
vec3 hrg_get_ideal_global_eye_pos(mat3 local_to_global, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist)
{
    ...
    else
    {
        ...
        vec3 _4408 = hrg_get_ideal_global_eye_pos_for_points(param_36, param_37, param_38, param_39, param_40, param_41);
        _4391 = _4408;
    }
    return _4391;
}
...
vec2 hrg_get_curved_video_uv_coords_and_tangent_matrix(vec2 flat_video_uv, vec3 eye_pos_local, vec2 output_pixel_size, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, mat3 global_to_local, out mat2 pixel_to_tangent_video_uv)
{
    ...
    vec3 param_5;
    vec2 _4633 = hrg_view_vec_to_uv(param, param_1, param_2, param_3, param_4, param_5);
    vec3 pos = param_5;
    vec2 centered_uv = _4633;
...
vec2 HRG_GetGeomCurvedCoord(vec2 in_coord, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, float in_geom_tilt_angle_x, float in_geom_tilt_angle_y, float in_screen_aspect, float pin_inner_edge, vec2 in_source_size, vec2 in_output_size, out mat2 pixel_to_video_uv)
{
    ...
    if (in_geom_mode > 0.5)
    {
        ...
        mat2 param_14;
        vec2 _4813 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14);
        pixel_to_video_uv = param_14;
        vec2 ctr_curved_coord = _4813 - vec2(0.5);
        if ((in_geom_tilt_angle_x == 0.0) && (in_geom_tilt_angle_y == 0.0))
        {
            ...
            mat2 param_23;
            vec2 _4842 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_15, param_16, param_17, param_18, param_19, param_20, param_21, param_22, param_23);
            pixel_to_video_uv = param_23;
            vec2 right_edge_curved_ctr_coord = _4842 - vec2(0.5);
            ...
            mat2 param_32;
            vec2 _4864 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_24, param_25, param_26, param_27, param_28, param_29, param_30, param_31, param_32);
            pixel_to_video_uv = param_32;
            vec2 bottom_edge_curved_ctr_coord = _4864 - vec2(0.5);
            ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
        ...
        if (pin_inner_edge == 1.0)
        {
            if (in_geom_tilt_angle_y != 0.0)
            {
                ...
                mat2 param_41;
                vec2 _4907 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_33, param_34, param_35, param_36, param_37, param_38, param_39, param_40, param_41);
                pixel_to_video_uv = param_41;
                vec2 top_edge_curved_ctr_coord = _4907;
            ...
            if (in_geom_tilt_angle_x != 0.0)
            {
                ...
                mat2 param_50;
                vec2 _4936 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_42, param_43, param_44, param_45, param_46, param_47, param_48, param_49, param_50);
                pixel_to_video_uv = param_50;
                vec2 left_edge_curved_ctr_coord = _4936;
...
vec2 HSM_Get2DCurvedCoord(vec2 in_coord, vec2 curvature_values)
{
    ...
    vec2 _5754 = HSM_GetCrtPiCurvedCoord(param, param_1);
    ctr_curved_coord = _5754 - vec2(0.5);
    vec2 param_2 = vec2(1.0, 0.5);
    vec2 param_3 = curvature_values;
    vec2 _5761 = HSM_GetCrtPiCurvedCoord(param_2, param_3);
    vec2 right_edge_curved_ctr_coord = _5761 - vec2(0.5);
    ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
    vec2 param_4 = vec2(0.5, 1.0);
    vec2 param_5 = curvature_values;
    vec2 _5775 = HSM_GetCrtPiCurvedCoord(param_4, param_5);
    vec2 bottom_edge_curved_ctr_coord = _5775 - vec2(0.5);
    ctr_curved_coord.y = (ctr_curved_coord.y * 0.5) / bottom_edge_curved_ctr_coord.y;
    return ctr_curved_coord + vec2(0.5);
}
...
vec2 HSM_GetCurvedCoord(vec2 in_coord, float curvature_multiplier, float screen_aspect)
{
    ...
    if (HSM_CURVATURE_MODE > CURVATURE_MODE_2D_CYLINDER)
    {
        ...
        else
        {
            ...
            mat2 param_16;
            vec2 _5883 = HRG_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16);
...
vec4 HSM_BlendModeLayerMix(vec4 color_under, inout vec4 color_over, float blend_mode, float layer_opacity)
{
    ...
    if (blend_mode == BLEND_MODE_NORMAL)
    {
        ...
        vec4 _2931 = color_over;
        vec3 _2933 = _2931.xyz * _2930;
    ...
    else
    {
        ...
        {
            vec3 _2957 = color_under.xyz + color_over.xyz;
        ...
        {
            vec3 _2973 = color_under.xyz * color_over.xyz;
...
vec4 BlendModeMaskLayerMix(vec4 color_under, inout vec4 color_over, float blend_mode, float mask_mode, float cutout_mode, float dualscreen_mode, float layer_opacity)
{
    ...
    if (blend_mode == BLEND_MODE_NORMAL)
    {
        ...
        vec4 _6817 = color_over;
        vec3 _6819 = _6817.xyz * _6816;
    ...
    else
    {
        ...
        if (blend_mode == BLEND_MODE_ADD)
        {
            vec3 _6843 = color_under.xyz + color_over.xyz;
        ...
        if (blend_mode == BLEND_MODE_MULTIPLY)
        {
            vec3 _6859 = color_under.xyz * color_over.xyz;
...
vec2 HSM_GetScaledCoord(vec2 in_viewport_coord, vec2 in_viewport_coord_unscaled, float texture_aspect_mode, inout float explicit_texture_aspect, vec2 offset_pos, inout vec2 offset_scale, float layer_to_follow, float follow_mode, float scale_full_with_zoom, float image_fill_mode, float split_preserve_center, float split_repeat_width, bool apply_default_scale_offset, inout vec2 out_placement_coord, inout vec2 out_placement_scale)
{
...
vec4 HSM_GetPreMultipliedColorLinear(vec4 in_color, float matte_type, float encoded_gamma)
{
    ...
    {
        vec4 _2841 = out_color;
        float _2844 = out_color.w;
        vec3 _2850 = clamp(_2841.xyz - vec3(1.0 - _2844), vec3(0.0), vec3(1.0));
        out_color.x = _2850.x;
        out_color.y = _2850.y;
        out_color.z = _2850.z;
    }
    ...
    if (matte_type == SOURCE_MATTE_NONE)
    {
        ...
        vec4 _2869 = out_color;
        vec3 _2871 = _2869.xyz * _2868;
        out_color.x = _2871.x;
        out_color.y = _2871.y;
        out_color.z = _2871.z;
    }
...
void main()
{
    ...
    vec4 _7266 = HSM_UpdateGlobalScreenValuesFromCache(InfoCachePass, param_3);
    ...
    float hmbz_bezel_brightness_frame_inner_edge = 0.01400000043213367462158203125;
    ...
    float inner_edge_highlight_multiplier = hmbz_bezel_brightness_frame_inner_edge + ((HSM_BZL_HIGHLIGHT * 10.0) * hmbz_bezel_brightness_frame_inner_edge);
    ...
    if (HSM_FRM_TEXTURE_OPACITY > 0.0)
    {
        ...
        vec4 _8181 = HSM_BlendModeLayerMix(param_101, param_102, param_103, param_104);
    ...
    if ((HSM_BZL_OPACITY > 0.0) || (HSM_FRM_OPACITY > 0.0))
    {
        ...
        vec3 _8262 = ApplyAmbientImages(param_109, param_110, param_111, param_112, param_113, param_114, param_115, param_116);
        ...
        if (HSM_FRM_SHADOW_OPACITY > 0.0)
        {
            ...
            float param_126 = 0.0;
            float param_127 = 1.0;
            vec4 _8320 = BlendModeMaskLayerMix(param_121, param_122, param_123, param_124, param_125, param_126, param_127);
            bezel_layer = _8320;
        }
    ...
    vec2 _8424 = HSM_GetScaledCoord(param_132, param_133, param_134, param_135, param_136, param_137, param_138, param_139, param_140, param_141, param_142, param_143, param_144, param_145, param_146);
    ...
    if (_8450)
    {
        ...
        vec3 _8490 = HSM_ApplyHSVAdjustment(param_157, param_158, param_159, param_160, param_161, param_162);
        bg_image.x = _8490.x;
        bg_image.y = _8490.y;
        bg_image.z = _8490.z;
        if (HSM_STATIC_LAYERS_GAMMA != 1.0)
        ...
        vec3 _8525 = ApplyAmbientImages(param_165, param_166, param_167, param_168, param_169, param_170, param_171, param_172);
        bg_image.x = _8525.x;
        bg_image.y = _8525.y;
        bg_image.z = _8525.z;
    }
    ...
    vec2 _8598 = HSM_GetScaledCoord(param_173, param_174, param_175, param_176, param_177, param_178, param_179, param_180, param_181, param_182, param_183, param_184, param_185, param_186, param_187);
    ...
    if (_8609)
    {
        ...
        vec3 _8651 = HSM_ApplyHSVAdjustment(param_197, param_198, param_199, param_200, param_201, param_202);
        ...
        vec3 _8686 = ApplyAmbientImages(param_205, param_206, param_207, param_208, param_209, param_210, param_211, param_212);
    ...
    vec2 _8737 = HSM_GetScaledCoord(param_213, param_214, param_215, param_216, param_217, param_218, param_219, param_220, param_221, param_222, param_223, param_224, param_225, param_226, param_227);
    ...
    if (_8748)
    {
        ...
        vec3 _8777 = HSM_ApplyHSVAdjustment(param_234, param_235, param_236, param_237, param_238, param_239);
        ...
        vec3 _8812 = ApplyAmbientImages(param_242, param_243, param_244, param_245, param_246, param_247, param_248, param_249);
    ...
    if (HSM_LED_OPACITY > 0.0)
    {
        ...
        vec2 _8868 = HSM_GetScaledCoord(param_250, param_251, param_252, param_253, param_254, param_255, param_256, param_257, param_258, param_259, param_260, param_261, param_262, param_263, param_264);
        LED_COORD = param_263;
        LED_SCALE = param_264;
        ...
        if (_8878)
        {
            ...
            vec3 _8907 = HSM_ApplyHSVAdjustment(param_271, param_272, param_273, param_274, param_275, param_276);
            led_image.x = _8907.x;
            led_image.y = _8907.y;
            led_image.z = _8907.z;
            if (HSM_STATIC_LAYERS_GAMMA != 1.0)
            ...
            vec3 _8942 = ApplyAmbientImages(param_279, param_280, param_281, param_282, param_283, param_284, param_285, param_286);
            led_image.x = _8942.x;
            led_image.y = _8942.y;
            led_image.z = _8942.z;
        }
    ...
    vec2 _8993 = HSM_GetScaledCoord(param_287, param_288, param_289, param_290, param_291, param_292, param_293, param_294, param_295, param_296, param_297, param_298, param_299, param_300, param_301);
    ...
    if (_9004)
    {
        ...
        vec3 _9033 = HSM_ApplyHSVAdjustment(param_308, param_309, param_310, param_311, param_312, param_313);
        ...
        vec3 _9068 = ApplyAmbientImages(param_316, param_317, param_318, param_319, param_320, param_321, param_322, param_323);
    ...
    vec2 _9119 = HSM_GetScaledCoord(param_324, param_325, param_326, param_327, param_328, param_329, param_330, param_331, param_332, param_333, param_334, param_335, param_336, param_337, param_338);
    ...
    if (_9137)
    {
        ...
        vec3 _9166 = HSM_ApplyHSVAdjustment(param_346, param_347, param_348, param_349, param_350, param_351);
        top_image.x = _9166.x;
        top_image.y = _9166.y;
        top_image.z = _9166.z;
        if (HSM_STATIC_LAYERS_GAMMA != 1.0)
        ...
        vec3 _9201 = ApplyAmbientImages(param_354, param_355, param_356, param_357, param_358, param_359, param_360, param_361);
        top_image.x = _9201.x;
        top_image.y = _9201.y;
        top_image.z = _9201.z;
    }
    ...
    if (HSM_CAB_GLASS_OPACITY > 0.0)
    {
        ...
        vec2 _9257 = HSM_GetScaledCoord(param_362, param_363, param_364, param_365, param_366, param_367, param_368, param_369, param_370, param_371, param_372, param_373, param_374, param_375, param_376);
        ...
        if (_9267)
        {
            ...
            vec3 _9296 = HSM_ApplyHSVAdjustment(param_383, param_384, param_385, param_386, param_387, param_388);
            ...
            vec3 _9331 = ApplyAmbientImages(param_391, param_392, param_393, param_394, param_395, param_396, param_397, param_398);
    ...
    vec2 _9393 = HSM_GetScaledCoord(param_399, param_400, param_401, param_402, param_403, param_404, param_405, param_406, param_407, param_408, param_409, param_410, param_411, param_412, param_413);
    temp_coord = param_412;
    temp_scale = param_413;
    vec2 cutout_coord = _9393;
    ...
    if (HSM_VIEWPORT_VIGNETTE_OPACITY > 0.0)
    {
        ...
        vec2 _9444 = HSM_GetScaledCoord(param_418, param_419, param_420, param_421, param_422, param_423, param_424, param_425, param_426, param_427, param_428, param_429, param_430, param_431, param_432);
        temp_coord = param_431;
        temp_scale = param_432;
        vec2 vignette_coord = _9444;
    ...
    for (int i = start_layer; i <= end_layer; i++)
    {
        if (HSM_BG_LAYER_ORDER == float(i))
        {
            ...
            vec4 _9513 = BlendModeMaskLayerMix(param_442, param_443, param_444, param_445, param_446, param_447, param_448);
        ...
        if (HSM_VIEWPORT_VIGNETTE_LAYER_ORDER == float(i))
        {
            ...
            vec4 _9533 = BlendModeMaskLayerMix(param_449, param_450, param_451, param_452, param_453, param_454, param_455);
        ...
        if ((HSM_LED_LAYER_ORDER == float(i)) && (HSM_LED_OPACITY > 0.0))
        {
            ...
            vec4 _9557 = BlendModeMaskLayerMix(param_456, param_457, param_458, param_459, param_460, param_461, param_462);
        ...
        if ((HSM_DEVICE_LAYER_ORDER == float(i)) && (HSM_DEVICE_OPACITY > 0.0))
        {
            ...
            vec4 _9581 = BlendModeMaskLayerMix(param_463, param_464, param_465, param_466, param_467, param_468, param_469);
        ...
        if ((HSM_DEVICELED_LAYER_ORDER == float(i)) && (HSM_DEVICELED_OPACITY > 0.0))
        {
            ...
            vec4 _9605 = BlendModeMaskLayerMix(param_470, param_471, param_472, param_473, param_474, param_475, param_476);
        ...
        if ((HSM_DECAL_LAYER_ORDER == float(i)) && (HSM_DECAL_OPACITY > 0.0))
        {
            ...
            vec4 _9629 = BlendModeMaskLayerMix(param_477, param_478, param_479, param_480, param_481, param_482, param_483);
        ...
        if ((HSM_CAB_GLASS_LAYER_ORDER == float(i)) && (HSM_CAB_GLASS_OPACITY > 0.0))
        {
            ...
            vec4 _9653 = BlendModeMaskLayerMix(param_484, param_485, param_486, param_487, param_488, param_489, param_490);
        ...
        if ((HSM_TOP_LAYER_ORDER == float(i)) && (HSM_TOP_OPACITY > 0.0))
        {
            ...
            vec4 _9677 = BlendModeMaskLayerMix(param_491, param_492, param_493, param_494, param_495, param_496, param_497);
    ...
    if ((HSM_BZL_OPACITY > 0.0) || (HSM_FRM_OPACITY > 0.0))
    {
        ...
        float param_505 = 0.0;
        float param_506 = 1.0;
        vec4 _9702 = BlendModeMaskLayerMix(param_500, param_501, param_502, param_503, param_504, param_505, param_506);
