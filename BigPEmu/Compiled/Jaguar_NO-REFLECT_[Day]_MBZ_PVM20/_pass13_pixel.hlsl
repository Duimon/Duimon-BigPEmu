...
Texture2D<float4> DerezedPass : register(t4);
SamplerState _DerezedPass_sampler : register(s4);
...
float3 fetch_pixel(float2 coord)
{
    ...
    float2 prescale_tex_size = float2(int2(spvTextureSize(DerezedPass, uint(0), _1559_dummy_parameter)));
