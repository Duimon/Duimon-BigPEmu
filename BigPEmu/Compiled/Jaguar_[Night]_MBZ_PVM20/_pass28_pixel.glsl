...
bool HSM_GetIsInABCompareArea(vec2 viewport_coord)
{
    ...
    {
        _4954 = 1.0 - HSM_AB_COMPARE_SPLIT_POSITION;
    }
    else
    {
    ...
    bool _4968 = (mod(HSM_AB_COMPARE_AREA, 2.0) == 0.0) && (test_value < position);
    bool _4979;
    if (!_4968)
    {
        _4979 = (mod(HSM_AB_COMPARE_AREA, 2.0) == 1.0) && (test_value > position);
    }
    else
    {
        _4979 = _4968;
...
vec2 HSM_GetGeomCurvedCoord(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, inout float in_distance, float in_aspect)
{
    ...
    vec2 _4180 = transform(param_5, param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 curved_coord = _4180;
    return curved_coord;
}
...
vec2 HSM_GetGeomCurvedCoordRetainWidth(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, float in_distance, float in_aspect)
{
    ...
    vec2 _4197 = HSM_GetGeomCurvedCoord(param, param_1, param_2, param_3, param_4, param_5);
    vec2 ctr_curved_coord = _4197 - vec2(0.5);
    ...
    vec2 _4212 = HSM_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 right_edge_curved_ctr_coord = _4212 - vec2(0.5);
...
vec3 hrg_get_ideal_global_eye_pos_for_points(inout vec3 eye_pos, vec2 output_aspect, vec3 global_coords[9], int num_points, float in_geom_radius, float in_geom_view_dist)
{
    ...
    for (int iter = 0; iter < max_centering_iters; iter++)
    {
        ...
        vec3 _2867 = eye_pos;
        vec2 _2869 = _2867.xy + center_offset;
        eye_pos.x = _2869.x;
        eye_pos.y = _2869.y;
...
vec3 hrg_get_ideal_global_eye_pos(mat3 local_to_global, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist)
{
    ...
    if (in_geom_mode < 2.5)
    {
        _3028 = vec3(0.0, 0.0, eye_z_spherical);
    }
    else
    {
        _3028 = vec3(0.0, 0.0, max(in_geom_view_dist, eye_z_spherical));
    }
    vec3 eye_pos = _3028;
    int num_points = 9;
    vec2 param = vec2(0.0);
    ...
    else
    {
        ...
        vec3 _3187 = hrg_get_ideal_global_eye_pos_for_points(param_36, param_37, param_38, param_39, param_40, param_41);
        _3170 = _3187;
    }
    return _3170;
}
...
vec2 hrg_get_curved_video_uv_coords_and_tangent_matrix(vec2 flat_video_uv, vec3 eye_pos_local, vec2 output_pixel_size, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, mat3 global_to_local, out mat2 pixel_to_tangent_video_uv)
{
    ...
    vec3 param_5;
    vec2 _3412 = hrg_view_vec_to_uv(param, param_1, param_2, param_3, param_4, param_5);
    vec3 pos = param_5;
    vec2 centered_uv = _3412;
    ...
    if (geom_force_correct_tangent_matrix)
    {
        ...
        {
            _3424 = vec3(pos.x, 0.0, pos.z);
        }
        vec3 normal_base = _3424;
...
vec2 HRG_GetGeomCurvedCoord(vec2 in_coord, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, float in_geom_tilt_angle_x, float in_geom_tilt_angle_y, float in_screen_aspect, float pin_inner_edge, vec2 in_source_size, vec2 in_output_size, out mat2 pixel_to_video_uv)
{
    ...
    if (in_geom_mode > 0.5)
    {
        ...
        mat2 param_14;
        vec2 _3592 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14);
        pixel_to_video_uv = param_14;
        vec2 ctr_curved_coord = _3592 - vec2(0.5);
        if ((in_geom_tilt_angle_x == 0.0) && (in_geom_tilt_angle_y == 0.0))
        {
            ...
            mat2 param_23;
            vec2 _3621 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_15, param_16, param_17, param_18, param_19, param_20, param_21, param_22, param_23);
            pixel_to_video_uv = param_23;
            vec2 right_edge_curved_ctr_coord = _3621 - vec2(0.5);
            ...
            mat2 param_32;
            vec2 _3643 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_24, param_25, param_26, param_27, param_28, param_29, param_30, param_31, param_32);
            pixel_to_video_uv = param_32;
            vec2 bottom_edge_curved_ctr_coord = _3643 - vec2(0.5);
            ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
        ...
        if (pin_inner_edge == 1.0)
        {
            if (in_geom_tilt_angle_y != 0.0)
            {
                ...
                mat2 param_41;
                vec2 _3686 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_33, param_34, param_35, param_36, param_37, param_38, param_39, param_40, param_41);
                pixel_to_video_uv = param_41;
                vec2 top_edge_curved_ctr_coord = _3686;
            ...
            if (in_geom_tilt_angle_x != 0.0)
            {
                ...
                mat2 param_50;
                vec2 _3715 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_42, param_43, param_44, param_45, param_46, param_47, param_48, param_49, param_50);
                pixel_to_video_uv = param_50;
                vec2 left_edge_curved_ctr_coord = _3715;
...
vec2 HSM_GetCurvatureValues(float screen_aspect)
{
    ...
    {
        _3742 = vec2((((2.0 * global.HSM_CURVATURE_2D_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0, ((global.HSM_CURVATURE_2D_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0);
    }
    else
    {
        _3742 = vec2(((global.HSM_CURVATURE_2D_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0, (((2.0 * global.HSM_CURVATURE_2D_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0);
    }
    vec2 curvature_values = _3742;
...
vec2 HSM_Get2DCurvedCoord(vec2 in_coord, vec2 curvature_values)
{
    ...
    vec2 _4276 = HSM_GetCrtPiCurvedCoord(param, param_1);
    ctr_curved_coord = _4276 - vec2(0.5);
    vec2 param_2 = vec2(1.0, 0.5);
    vec2 param_3 = curvature_values;
    vec2 _4283 = HSM_GetCrtPiCurvedCoord(param_2, param_3);
    vec2 right_edge_curved_ctr_coord = _4283 - vec2(0.5);
    ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
    vec2 param_4 = vec2(0.5, 1.0);
    vec2 param_5 = curvature_values;
    vec2 _4297 = HSM_GetCrtPiCurvedCoord(param_4, param_5);
    vec2 bottom_edge_curved_ctr_coord = _4297 - vec2(0.5);
    ctr_curved_coord.y = (ctr_curved_coord.y * 0.5) / bottom_edge_curved_ctr_coord.y;
    return ctr_curved_coord + vec2(0.5);
}
...
vec2 HSM_GetCurvedCoord(vec2 in_coord, float curvature_multiplier, float screen_aspect)
{
    ...
    if (HSM_CURVATURE_MODE > CURVATURE_MODE_2D_CYLINDER)
    {
        ...
        else
        {
            ...
            mat2 param_16;
            vec2 _4405 = HRG_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16);
...
vec2 HSM_GetTubeCurvedCoord(vec2 screen_coord, float curvature_scale, vec2 screen_scale, vec2 tube_scale, float screen_aspect, float apply_black_edge_offset)
{
    ...
    if (global.HSM_BZL_USE_INDEPENDENT_CURVATURE == 1.0)
    {
        ...
        if (screen_aspect < 1.0)
        {
            _4474 = vec2((((2.0 * global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0, ((global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0);
        }
        else
        {
            _4474 = vec2(((global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0, (((2.0 * global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0);
        }
        vec2 curvature_values = _4474;
...
float HSM_GetBezelCoords(vec2 tube_diffuse_coord, vec2 tube_diffuse_scale, vec2 tube_scale, float screen_aspect, bool curve_coords_on, out vec2 bezel_outside_scale, inout vec2 bezel_outside_coord, inout vec2 bezel_outside_curved_coord, inout vec2 frame_outside_curved_coord)
{
    ...
    if (curve_coords_on)
    {
        bool _5101 = HSM_CURVATURE_MODE > 0.0;
        bool _5109;
        if (_5101)
        {
            _5109 = (HSM_CURVATURE_3D_TILT_ANGLE_X != 0.0) || (HSM_CURVATURE_3D_TILT_ANGLE_Y != 0.0);
        }
        else
        {
            _5109 = _5101;
...
{
    bool _1848 = abs(in_coord.x - 0.5) > 0.500999987125396728515625;
    bool _1857;
    if (!_1848)
    {
        _1857 = abs(in_coord.y - 0.5) > 0.500999987125396728515625;
    }
    else
    {
        _1857 = _1848;
...
void main()
{
    ...
    bool _5254 = HSM_AB_COMPARE_FREEZE_CRT_TUBE == 1.0;
    bool _5262;
    if (_5254)
    {
    ...
    vec4 _5281 = HSM_UpdateGlobalScreenValuesFromCache(InfoCachePass, param_3);
    ...
    {
        _5664 = 1.0 - smoothstep(0.0, corner_fade_width / 2.0, distance_from_crease_shifted);
    }
    else
    {
        _5664 = 1.0;
    ...
    else
    {
        ...
        _5703 = 1.0 - HSM_GetCornerMask(param_46, param_47, param_48, param_49);
    }
    ...
    vec4 _5768 = crt_linear;
    vec3 _5770 = _5768.xyz * (tube_edge_shadow_mult * (1.0 - outside_tube_mask_wider));
    ...
    if (HSM_GLASS_BORDER_ON == 1.0)
    {
        ...
        edge_top_center_highlight_mask = (0.60000002384185791015625 * top_mask) * _5845;
        ...
        edge_sides_highlight_mask = (0.699999988079071044921875 * sides_mask) * _5866;
    }
    ...
    if (HSM_REFLECT_GLOBAL_AMOUNT > 0.0)
    {
        ...
        float radial_fade_sides = 1.0 - _5919;
        ...
        float radial_fade_top_bottom = 1.0 - _5932;
        ...
        float radial_inner_fade_mask = clamp(0.300000011920928955078125 + (0.699999988079071044921875 * _5953), 0.0, 1.0);
        ...
        float stoichaic_blur_max = _6036 * 3.0;
        ...
        if (HSM_GLASS_BORDER_ON == 1.0)
        {
            ...
            float vignette_shadow_mask = 0.75 * _6153;
            ...
            vignette_shadow_mask += ((0.5 * HSM_REFLECT_VIGNETTE_AMOUNT) * _6161);
        ...
        vec4 _6266 = reflection_color;
        vec3 _6268 = _6266.xyz * (((1.0 - HSM_REFLECT_FRAME_INNER_EDGE_AMOUNT) * (1.0 - frame_inner_edge_mask)) + HSM_REFLECT_FRAME_INNER_EDGE_AMOUNT);
        reflection_color.x = _6268.x;
        reflection_color.y = _6268.y;
        reflection_color.z = _6268.z;
    }
    vec4 _6276 = crt_linear;
    vec3 _6278 = _6276.xyz * TUBE_MASK;
    ...
    vec4 _6292 = FragColor;
    vec3 _6294 = _6292.xyz + reflection_color.xyz;
    FragColor.x = _6294.x;
    FragColor.y = _6294.y;
    FragColor.z = _6294.z;
