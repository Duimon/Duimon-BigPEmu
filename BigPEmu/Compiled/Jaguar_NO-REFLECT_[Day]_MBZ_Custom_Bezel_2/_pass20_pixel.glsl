...
layout(binding = 12) uniform sampler2D DerezedPass;
...
bool HSM_GetIsInABCompareArea(vec2 viewport_coord)
{
    ...
    {
        _6513 = 1.0 - HSM_AB_COMPARE_SPLIT_POSITION;
    }
    else
    {
    ...
    bool _6527 = (mod(HSM_AB_COMPARE_AREA, 2.0) == 0.0) && (test_value < position);
    bool _6538;
    if (!_6527)
    {
        _6538 = (mod(HSM_AB_COMPARE_AREA, 2.0) == 1.0) && (test_value > position);
    }
    else
    {
        _6538 = _6527;
...
{
    bool _3044 = abs(in_coord.x - 0.5) > 0.500999987125396728515625;
    bool _3053;
    if (!_3044)
    {
        _3053 = abs(in_coord.y - 0.5) > 0.500999987125396728515625;
    }
    else
    {
        _3053 = _3044;
...
vec2 HSM_GetGeomCurvedCoord(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, inout float in_distance, float in_aspect)
{
    ...
    vec2 _5652 = transform(param_5, param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 curved_coord = _5652;
    return curved_coord;
}
...
vec2 HSM_GetGeomCurvedCoordRetainWidth(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, float in_distance, float in_aspect)
{
    ...
    vec2 _5669 = HSM_GetGeomCurvedCoord(param, param_1, param_2, param_3, param_4, param_5);
    vec2 ctr_curved_coord = _5669 - vec2(0.5);
    ...
    vec2 _5684 = HSM_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 right_edge_curved_ctr_coord = _5684 - vec2(0.5);
...
vec3 hrg_get_ideal_global_eye_pos_for_points(inout vec3 eye_pos, vec2 output_aspect, vec3 global_coords[9], int num_points, float in_geom_radius, float in_geom_view_dist)
{
    ...
    for (int iter = 0; iter < max_centering_iters; iter++)
    {
        ...
        vec3 _4062 = eye_pos;
        vec2 _4064 = _4062.xy + center_offset;
        eye_pos.x = _4064.x;
        eye_pos.y = _4064.y;
...
vec3 hrg_get_ideal_global_eye_pos(mat3 local_to_global, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist)
{
    ...
    if (in_geom_mode < 2.5)
    {
        _4223 = vec3(0.0, 0.0, eye_z_spherical);
    }
    else
    {
        _4223 = vec3(0.0, 0.0, max(in_geom_view_dist, eye_z_spherical));
    }
    vec3 eye_pos = _4223;
    int num_points = 9;
    vec2 param = vec2(0.0);
    ...
    else
    {
        ...
        vec3 _4382 = hrg_get_ideal_global_eye_pos_for_points(param_36, param_37, param_38, param_39, param_40, param_41);
        _4365 = _4382;
    }
    return _4365;
}
...
vec2 hrg_get_curved_video_uv_coords_and_tangent_matrix(vec2 flat_video_uv, vec3 eye_pos_local, vec2 output_pixel_size, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, mat3 global_to_local, out mat2 pixel_to_tangent_video_uv)
{
    ...
    vec3 param_5;
    vec2 _4607 = hrg_view_vec_to_uv(param, param_1, param_2, param_3, param_4, param_5);
    vec3 pos = param_5;
    vec2 centered_uv = _4607;
    ...
    if (geom_force_correct_tangent_matrix)
    {
        ...
        {
            _4619 = vec3(pos.x, 0.0, pos.z);
        }
        vec3 normal_base = _4619;
...
vec2 HRG_GetGeomCurvedCoord(vec2 in_coord, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, float in_geom_tilt_angle_x, float in_geom_tilt_angle_y, float in_screen_aspect, float pin_inner_edge, vec2 in_source_size, vec2 in_output_size, out mat2 pixel_to_video_uv)
{
    ...
    if (in_geom_mode > 0.5)
    {
        ...
        mat2 param_14;
        vec2 _4787 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14);
        pixel_to_video_uv = param_14;
        vec2 ctr_curved_coord = _4787 - vec2(0.5);
        if ((in_geom_tilt_angle_x == 0.0) && (in_geom_tilt_angle_y == 0.0))
        {
            ...
            mat2 param_23;
            vec2 _4816 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_15, param_16, param_17, param_18, param_19, param_20, param_21, param_22, param_23);
            pixel_to_video_uv = param_23;
            vec2 right_edge_curved_ctr_coord = _4816 - vec2(0.5);
            ...
            mat2 param_32;
            vec2 _4838 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_24, param_25, param_26, param_27, param_28, param_29, param_30, param_31, param_32);
            pixel_to_video_uv = param_32;
            vec2 bottom_edge_curved_ctr_coord = _4838 - vec2(0.5);
            ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
        ...
        if (pin_inner_edge == 1.0)
        {
            if (in_geom_tilt_angle_y != 0.0)
            {
                ...
                mat2 param_41;
                vec2 _4881 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_33, param_34, param_35, param_36, param_37, param_38, param_39, param_40, param_41);
                pixel_to_video_uv = param_41;
                vec2 top_edge_curved_ctr_coord = _4881;
            ...
            if (in_geom_tilt_angle_x != 0.0)
            {
                ...
                mat2 param_50;
                vec2 _4910 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_42, param_43, param_44, param_45, param_46, param_47, param_48, param_49, param_50);
                pixel_to_video_uv = param_50;
                vec2 left_edge_curved_ctr_coord = _4910;
...
vec2 HSM_GetCurvatureValues(float screen_aspect)
{
    ...
    {
        _5213 = vec2((((2.0 * global.HSM_CURVATURE_2D_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0, ((global.HSM_CURVATURE_2D_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0);
    }
    else
    {
        _5213 = vec2(((global.HSM_CURVATURE_2D_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0, (((2.0 * global.HSM_CURVATURE_2D_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0);
    }
    vec2 curvature_values = _5213;
...
vec2 HSM_Get2DCurvedCoord(vec2 in_coord, vec2 curvature_values)
{
    ...
    vec2 _5748 = HSM_GetCrtPiCurvedCoord(param, param_1);
    ctr_curved_coord = _5748 - vec2(0.5);
    vec2 param_2 = vec2(1.0, 0.5);
    vec2 param_3 = curvature_values;
    vec2 _5755 = HSM_GetCrtPiCurvedCoord(param_2, param_3);
    vec2 right_edge_curved_ctr_coord = _5755 - vec2(0.5);
    ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
    vec2 param_4 = vec2(0.5, 1.0);
    vec2 param_5 = curvature_values;
    vec2 _5769 = HSM_GetCrtPiCurvedCoord(param_4, param_5);
    vec2 bottom_edge_curved_ctr_coord = _5769 - vec2(0.5);
    ctr_curved_coord.y = (ctr_curved_coord.y * 0.5) / bottom_edge_curved_ctr_coord.y;
    return ctr_curved_coord + vec2(0.5);
}
...
vec2 HSM_GetCurvedCoord(vec2 in_coord, float curvature_multiplier, float screen_aspect)
{
    ...
    if (HSM_CURVATURE_MODE > CURVATURE_MODE_2D_CYLINDER)
    {
        ...
        else
        {
            ...
            mat2 param_16;
            vec2 _5876 = HRG_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16);
...
vec2 HSM_GetTubeCurvedCoord(vec2 screen_coord, float curvature_scale, vec2 screen_scale, vec2 tube_scale, float screen_aspect, float apply_black_edge_offset)
{
    ...
    if (global.HSM_BZL_USE_INDEPENDENT_CURVATURE == 1.0)
    {
        ...
        if (screen_aspect < 1.0)
        {
            _6033 = vec2((((2.0 * global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0, ((global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0);
        }
        else
        {
            _6033 = vec2(((global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0, (((2.0 * global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0);
        }
        vec2 curvature_values = _6033;
...
float HSM_GetBezelCoords(vec2 tube_diffuse_coord, vec2 tube_diffuse_scale, vec2 tube_scale, float screen_aspect, bool curve_coords_on, out vec2 bezel_outside_scale, inout vec2 bezel_outside_coord, inout vec2 bezel_outside_curved_coord, inout vec2 frame_outside_curved_coord)
{
    ...
    if (curve_coords_on)
    {
        bool _7292 = HSM_CURVATURE_MODE > 0.0;
        bool _7300;
        if (_7292)
        {
            _7300 = (HSM_CURVATURE_3D_TILT_ANGLE_X != 0.0) || (HSM_CURVATURE_3D_TILT_ANGLE_Y != 0.0);
        }
        else
        {
            _7300 = _7292;
...
vec3 HSM_RGBtoHSV(vec3 c)
{
    ...
    if (c.y < c.z)
    {
        _2664 = vec4(c.zy, K.wz);
    }
    else
    {
        _2664 = vec4(c.yz, K.xy);
    }
    vec4 p = _2664;
    vec4 _2694;
    if (c.x < p.x)
    {
        _2694 = vec4(p.xyw, c.x);
    }
    else
    {
        _2694 = vec4(c.x, p.yzx);
    }
    vec4 q = _2694;
...
vec4 HSM_ApplyMonochrome(vec4 in_color)
{
    ...
    vec4 _6838 = out_color;
    vec3 _6844 = pow(_6838.xyz, vec3(global.HSM_MONOCHROME_GAMMA));
    out_color.x = _6844.x;
    out_color.y = _6844.y;
    out_color.z = _6844.z;
    ...
    bool _6884 = (global.HSM_MONOCHROME_HUE_OFFSET / 360.0) != 0.0;
    bool _6893;
    if (!_6884)
    {
        _6893 = (global.HSM_MONOCHROME_SATURATION / 100.0) != 0.0;
    }
    else
    {
        _6893 = _6884;
    ...
    vec3 _6923 = mcolor * pow(luma, 1.0 / global.HSM_MONOCHROME_GAMMA);
    out_color.x = _6923.x;
    out_color.y = _6923.y;
    out_color.z = _6923.z;
    return out_color;
...
vec2 HSM_GetMirrorWrappedCoord(inout vec2 in_coord)
{
    ...
    bool _5900 = abs(ctr_coord.x) > 0.5;
    bool _5908;
    if (!_5900)
    {
        _5908 = abs(ctr_coord.y) > 0.5;
    }
    else
    {
        _5908 = _5900;
...
{
    vec2 param = in_coord;
    vec2 _6579 = HSM_GetMirrorWrappedCoord(param);
    vec2 vpos = _6579;
...
{
    bool _6628 = global.HSM_SCREEN_VIGNETTE_ON > 0.5;
    bool _6634;
    if (_6628)
    {
...
vec4 HSM_GetCroppedTexSample(sampler2D in_sampler, vec2 in_screen_coord)
{
    ...
    vec4 _6573 = HSM_GetTexSampleFromSampleStartAndSize(in_sampler, param, param_1, param_2);
    return _6573;
}
...
vec2 GetSimpleImageScaledCoord(inout vec2 in_viewport_coord, vec2 in_viewport_unscaled_coord, vec2 in_tube_coord, vec2 in_tube_scale, sampler2D in_sampler, vec2 in_pos, float in_inherit_pos, vec2 in_scale, float in_scale_inherit_mode, float in_keep_aspect, float in_mirror_horz, float in_rotate)
{
    ...
    if (in_rotate > 0.5)
    {
        _5175 = global.FinalViewportSize.x / global.FinalViewportSize.y;
    }
    else
    {
        _5175 = 1.0;
    }
    coord_ctr /= vec2(_5175);
    if (in_rotate > 0.5)
    {
...
vec4 HSM_GetNightLightingMultiplyColor(vec2 in_coord, float hue, float saturation, float value, float contrast, float global_ambient_opacity, sampler2D NightLightingImage_1)
{
    ...
    vec4 _6695 = lighting_image;
    vec3 _6699 = mix(vec3(1.0), _6695.xyz, vec3(global_ambient_opacity));
...
bool HSM_Fill_Ambient_Images(vec2 in_viewport_coord, vec2 in_viewport_unscaled_coord, vec2 in_tube_coord, vec2 in_tube_scale, float in_swap_images, sampler2D in_ambient_sampler, sampler2D in_ambient2_sampler, out vec4 ambient_lighting_image, out vec4 ambient2_lighting_image)
{
    ...
    if (HSM_AMBIENT1_OPACITY > 0.0)
    {
        ...
        bool _6717 = HSM_AMBIENT1_SCALE_INHERIT_MODE == 1.0;
        bool _6724;
        if (_6717)
        {
            _6724 = (HSM_AMBIENT1_SCALE * HSM_VIEWPORT_ZOOM) < 1.0;
        }
        else
        {
            _6724 = _6717;
        ...
        vec2 _6758 = GetSimpleImageScaledCoord(param, param_1, param_2, param_3, in_ambient_sampler, param_4, param_5, param_6, param_7, param_8, param_9, param_10);
        vec2 lighting_coord = _6758;
    ...
    if (HSM_AMBIENT2_OPACITY > 0.0)
    {
        ...
        bool _6779 = HSM_AMBIENT2_SCALE_INHERIT_MODE == 1.0;
        bool _6786;
        if (_6779)
        {
            _6786 = (HSM_AMBIENT2_SCALE * HSM_VIEWPORT_ZOOM) < 1.0;
        }
        else
        {
            _6786 = _6779;
        ...
        vec2 _6820 = GetSimpleImageScaledCoord(param_17, param_18, param_19, param_20, in_ambient2_sampler, param_21, param_22, param_23, param_24, param_25, param_26, param_27);
        vec2 lighting2_coord = _6820;
...
{
    bool _7443 = HSM_TUBE_DIFFUSE_MODE == 1.0;
    bool _7449;
    if (_7443)
    {
...
{
    bool _7453 = HSM_TUBE_COLORED_GEL_IMAGE_ON > 0.5;
    bool _7459;
    if (_7453)
    {
...
{
    bool _7433 = HSM_TUBE_STATIC_REFLECTION_IMAGE_ON > 0.5;
    bool _7439;
    if (_7433)
    {
...
vec4 HSM_GetPreMultipliedColorLinear(vec4 in_color, float matte_type, float encoded_gamma)
{
    ...
    {
        vec4 _2870 = out_color;
        float _2873 = out_color.w;
        vec3 _2879 = clamp(_2870.xyz - vec3(1.0 - _2873), vec3(0.0), vec3(1.0));
        out_color.x = _2879.x;
        out_color.y = _2879.y;
        out_color.z = _2879.z;
    }
    ...
    if (matte_type == SOURCE_MATTE_NONE)
    {
        ...
        vec4 _2898 = out_color;
        vec3 _2900 = _2898.xyz * _2897;
        out_color.x = _2900.x;
        out_color.y = _2900.y;
        out_color.z = _2900.z;
    }
...
vec4 HSM_BlendModeLayerMix(vec4 color_under, inout vec4 color_over, float blend_mode, float layer_opacity)
{
    ...
    if (blend_mode == BLEND_MODE_NORMAL)
    {
        ...
        vec4 _2960 = color_over;
        vec3 _2962 = _2960.xyz * _2959;
    ...
    else
    {
        ...
        {
            vec3 _2986 = color_under.xyz + color_over.xyz;
        ...
        {
            vec3 _3002 = color_under.xyz * color_over.xyz;
...
vec4 HSM_GetTubeHighlight(inout vec2 tube_curved_coord, bool apply_to_mirror, sampler2D TubeStaticReflectionImage_1)
{
    ...
    if (apply_to_mirror)
    {
        ...
        vec2 _7473 = HSM_GetMirrorWrappedCoord(param_1);
    ...
    vec4 _7574 = out_color;
    vec3 _7576 = _7574.xyz * HSM_GLOBAL_GRAPHICS_BRIGHTNESS;
    out_color.x = _7576.x;
    out_color.y = _7576.y;
    out_color.z = _7576.z;
    return out_color;
...
{
    bool _7588 = global.HSM_MONOCHROME_MODE > 0.5;
    bool _7594;
    if (_7588)
    {
    ...
    vec2 _7610 = HSM_GetMirrorWrappedCoord(param_2);
    vec2 mirrored_screen_coord = _7610;
    vec4 out_color = vec4(0.0);
    ...
    vec2 _7648 = HSM_GetMirrorWrappedCoord(param_13);
    vec2 mirrored_tube_coord = _7648;
    ...
    bool _7681 = HSM_AB_COMPARE_SHOW_MODE == 1.0;
    bool _7687;
    if (_7681)
    {
    ...
    if (_7687)
    {
        ...
        vec2 _7701 = HSM_GetMirrorWrappedCoord(param_16);
    ...
    vec4 _7779 = crt_color;
    vec3 _7781 = _7779.xyz * screen_to_tube_mask_invert;
    crt_color.x = _7781.x;
    crt_color.y = _7781.y;
    crt_color.z = _7781.z;
    ...
    bool _7804 = HSM_Fill_Ambient_Images(param_34, param_35, param_36, param_37, param_38, NightLightingImage_1, NightLighting2Image_1, param_39, param_40);
    ambient_lighting_image = param_39;
    ambient2_lighting_image = param_40;
    vec3 tube_shadow = vec3(1.0);
    bool _7809 = HSM_TUBE_SHADOW_IMAGE_ON > 0.5;
    bool _7823;
    if (_7809)
    {
    ...
    if (_7823)
    {
        ...
        vec2 _7830 = HSM_GetMirrorWrappedCoord(param_41);
        shadow_coord = _7830;
    ...
    {
        bool _7923 = adjusted_tube_diffuse_amount > 0.0;
        bool _7930;
        if (!_7923)
        {
            _7930 = global.HSM_CRT_BLEND_MODE == 2.0;
        }
        else
        {
            _7930 = _7923;
        ...
        if (_7930)
        {
            ...
            vec2 _7937 = HSM_GetMirrorWrappedCoord(param_51);
            diffuse_coord = _7937;
            ...
            vec3 _7987 = HSM_GetPreMultipliedColorLinear(param_57, param_58, param_59).xyz * HSM_GLOBAL_GRAPHICS_BRIGHTNESS;
            ...
            vec3 _8007 = HSM_ApplyHSVAdjustment(param_60, param_61, param_62, param_63, param_64, param_65);
            tube_diffuse.x = _8007.x;
            tube_diffuse.y = _8007.y;
            tube_diffuse.z = _8007.z;
            vec4 _8015 = tube_diffuse;
            vec3 _8017 = _8015.xyz * HSM_TUBE_DIFFUSE_IMAGE_AMOUNT;
            tube_diffuse.x = _8017.x;
            tube_diffuse.y = _8017.y;
            tube_diffuse.z = _8017.z;
            vec4 _8025 = tube_diffuse;
            vec3 _8027 = _8025.xyz * tube_shadow;
        ...
        vec3 _8042 = HSM_ApplyAmbientImage(param_66, param_67, param_68);
        ...
        vec3 _8057 = HSM_ApplyAmbientImage(param_69, param_70, param_71);
    ...
    vec4 _8075 = out_color;
    vec3 _8077 = _8075.xyz + crt_color.xyz;
    out_color.x = _8077.x;
    out_color.y = _8077.y;
    out_color.z = _8077.z;
    ...
    {
        vec4 _8097 = out_color;
        vec3 _8099 = _8097.xyz + tube_diffuse.xyz;
        out_color.x = _8099.x;
        out_color.y = _8099.y;
        out_color.z = _8099.z;
    }
    if (global.HSM_CRT_BLEND_MODE == 2.0)
    {
        ...
        vec4 _8126 = HSM_BlendModeLayerMix(param_72, param_73, param_74, param_75);
        out_color = _8126;
    }
    if (HSM_GetUseTubeColoredGelImage())
    {
        vec2 param_76 = tube_diffuse_curved_coord;
        vec2 _8133 = HSM_GetMirrorWrappedCoord(param_76);
        vec2 gel_coord = _8133;
        ...
        {
            vec4 _8173 = out_color;
            vec4 _8175 = out_color;
            vec3 _8182 = mix(_8173.xyz, _8175.xyz * gel_image.xyz, vec3(HSM_TUBE_COLORED_GEL_IMAGE_MULTIPLY_AMOUNT));
            out_color.x = _8182.x;
            out_color.y = _8182.y;
            out_color.z = _8182.z;
        }
        ...
        {
            vec4 _8193 = out_color;
            vec4 _8195 = out_color;
            vec3 _8202 = mix(_8193.xyz, _8195.xyz + gel_image.xyz, vec3(HSM_TUBE_COLORED_GEL_IMAGE_ADDITIVE_AMOUNT));
            out_color.x = _8202.x;
            out_color.y = _8202.y;
            out_color.z = _8202.z;
        }
        if (HSM_TUBE_COLORED_GEL_IMAGE_NORMAL_AMOUNT > 0.0)
        {
            ...
            vec4 _8223 = gel_image;
            vec3 _8225 = _8223.xyz * HSM_TUBE_COLORED_GEL_IMAGE_NORMAL_BRIGHTNESS;
            gel_image.x = _8225.x;
            gel_image.y = _8225.y;
            gel_image.z = _8225.z;
            vec4 _8233 = gel_image;
            vec3 _8235 = _8233.xyz * tube_shadow;
            gel_image.x = _8235.x;
            gel_image.y = _8235.y;
            gel_image.z = _8235.z;
            if (HSM_TUBE_COLORED_GEL_IMAGE_FAKE_SCANLINE_AMOUNT > 0.001000000047497451305389404296875)
            {
                ...
                vec4 _8258 = HSM_ApplyScanlineMask(param_82, param_83, param_84, param_85, param_86, param_87);
            ...
            vec3 _8274 = HSM_ApplyAmbientImage(param_88, param_89, param_90);
            gel_image.x = _8274.x;
            gel_image.y = _8274.y;
            gel_image.z = _8274.z;
            ...
            vec3 _8289 = HSM_ApplyAmbientImage(param_91, param_92, param_93);
            gel_image.x = _8289.x;
            gel_image.y = _8289.y;
            gel_image.z = _8289.z;
            ...
            vec4 _8309 = HSM_BlendModeLayerMix(param_94, param_95, param_96, param_97);
            gel_image = _8309;
            if (HSM_SHOW_CRT_ON_TOP_OF_COLORED_GEL == 0.0)
            {
                ...
                vec4 _8322 = HSM_BlendModeLayerMix(param_98, param_99, param_100, param_101);
                out_color = _8322;
            }
            if (HSM_SHOW_CRT_ON_TOP_OF_COLORED_GEL == 1.0)
            {
                vec4 _8328 = gel_image;
                vec3 _8330 = _8328.xyz * tube_shadow;
                gel_image.x = _8330.x;
                gel_image.y = _8330.y;
                gel_image.z = _8330.z;
                ...
                vec4 _8346 = HSM_BlendModeLayerMix(param_102, param_103, param_104, param_105);
                vec4 normal_blended = _8346;
                out_color = normal_blended + out_color;
            }
        }
    }
    vec4 _8351 = out_color;
    vec3 _8353 = _8351.xyz * tube_diffuse_mask;
    out_color.x = _8353.x;
    out_color.y = _8353.y;
    out_color.z = _8353.z;
    out_color *= tube_mask;
    if (HSM_GetUseTubeStaticReflection())
    {
        ...
        vec4 _8370 = HSM_GetTubeHighlight(param_106, param_107, TubeStaticReflectionImage_1);
        vec3 tube_highlight_image = _8370.xyz;
        ...
        vec4 _8418 = out_color;
        vec3 _8420 = _8418.xyz + (tube_highlight_image * HSM_TUBE_STATIC_REFLECTION_IMAGE_OPACITY);
        out_color.x = _8420.x;
        out_color.y = _8420.y;
        out_color.z = _8420.z;
    }
...
void main()
{
    ...
    {
        _812 = global.HSM_SNAP_TO_CLOSEST_INT_SCALE_TOLERANCE / 100.0;
    }
    else
    {
        _812 = 0.0;
    ...
    bool _8444 = HSM_AB_COMPARE_FREEZE_CRT_TUBE == 1.0;
    bool _8452;
    if (_8444)
    {
    ...
    vec4 _8472 = HSM_UpdateGlobalScreenValuesFromCache(InfoCachePass, param_3);
    vec2 cache_bounds_coord = TUBE_COORD;
    vec2 param_4 = cache_bounds_coord;
    if (HHLP_IsOutsideCoordSpace(param_4))
    {
        FragColor = vec4(0.0);
        return;
    }
    vec2 param_5 = TUBE_DIFFUSE_COORD;
    vec2 param_6 = TUBE_DIFFUSE_SCALE;
    vec2 param_7 = TUBE_SCALE;
    float param_8 = SCREEN_ASPECT;
    bool param_9 = false;
    vec2 param_10 = BEZEL_OUTSIDE_SCALE;
    vec2 param_11 = BEZEL_OUTSIDE_COORD;
    vec2 param_12 = BEZEL_OUTSIDE_CURVED_COORD;
    vec2 param_13 = FRAME_OUTSIDE_CURVED_COORD;
    ...
    vec2 param_14 = SCREEN_COORD;
    float param_15 = 1.0;
    float param_16 = SCREEN_ASPECT;
    vec2 screen_curved_coord = HSM_GetCurvedCoord(param_14, param_15, param_16);
    FragColor = texture(Source, UNFLIPPED_VIEWPORT_COORD);
    vec4 param_17 = FragColor;
    vec2 param_18 = vTexCoord;
    vec2 param_19 = screen_curved_coord;
    vec4 _8529 = HSM_GetPostCrtPreppedColor(param_17, param_18, param_19, DerezedPass, TubeDiffuseImage, TubeColoredGelImage, TubeStaticReflectionImage, BackgroundImage, BackgroundVertImage, NightLightingImage, NightLighting2Image);
    FragColor = _8529;
}
