...
vec2 HSM_GetGeomCurvedCoord(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, inout float in_distance, float in_aspect)
{
    ...
    vec2 _4070 = transform(param_5, param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 curved_coord = _4070;
    return curved_coord;
}
...
vec2 HSM_GetGeomCurvedCoordRetainWidth(vec2 in_coord, float tilt_x, float tilt_y, float in_radius, float in_distance, float in_aspect)
{
    ...
    vec2 _4087 = HSM_GetGeomCurvedCoord(param, param_1, param_2, param_3, param_4, param_5);
    vec2 ctr_curved_coord = _4087 - vec2(0.5);
    ...
    vec2 _4102 = HSM_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11);
    vec2 right_edge_curved_ctr_coord = _4102 - vec2(0.5);
...
vec3 hrg_get_ideal_global_eye_pos_for_points(inout vec3 eye_pos, vec2 output_aspect, vec3 global_coords[9], int num_points, float in_geom_radius, float in_geom_view_dist)
{
    ...
    for (int iter = 0; iter < max_centering_iters; iter++)
    {
        ...
        vec3 _2649 = eye_pos;
        vec2 _2651 = _2649.xy + center_offset;
        eye_pos.x = _2651.x;
        eye_pos.y = _2651.y;
...
vec3 hrg_get_ideal_global_eye_pos(mat3 local_to_global, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist)
{
    ...
    if (in_geom_mode < 2.5)
    {
        _2810 = vec3(0.0, 0.0, eye_z_spherical);
    }
    else
    {
        _2810 = vec3(0.0, 0.0, max(in_geom_view_dist, eye_z_spherical));
    }
    vec3 eye_pos = _2810;
    int num_points = 9;
    vec2 param = vec2(0.0);
    ...
    else
    {
        ...
        vec3 _2970 = hrg_get_ideal_global_eye_pos_for_points(param_36, param_37, param_38, param_39, param_40, param_41);
        _2953 = _2970;
    }
    return _2953;
}
...
vec2 hrg_get_curved_video_uv_coords_and_tangent_matrix(vec2 flat_video_uv, vec3 eye_pos_local, vec2 output_pixel_size, vec2 output_aspect, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, mat3 global_to_local, out mat2 pixel_to_tangent_video_uv)
{
    ...
    vec3 param_5;
    vec2 _3195 = hrg_view_vec_to_uv(param, param_1, param_2, param_3, param_4, param_5);
    vec3 pos = param_5;
    vec2 centered_uv = _3195;
    ...
    if (geom_force_correct_tangent_matrix)
    {
        ...
        {
            _3207 = vec3(pos.x, 0.0, pos.z);
        }
        vec3 normal_base = _3207;
...
vec2 HRG_GetGeomCurvedCoord(vec2 in_coord, float in_geom_mode, float in_geom_radius, float in_geom_view_dist, float in_geom_tilt_angle_x, float in_geom_tilt_angle_y, float in_screen_aspect, float pin_inner_edge, vec2 in_source_size, vec2 in_output_size, out mat2 pixel_to_video_uv)
{
    ...
    if (in_geom_mode > 0.5)
    {
        ...
        mat2 param_14;
        vec2 _3375 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14);
        pixel_to_video_uv = param_14;
        vec2 ctr_curved_coord = _3375 - vec2(0.5);
        if ((in_geom_tilt_angle_x == 0.0) && (in_geom_tilt_angle_y == 0.0))
        {
            ...
            mat2 param_23;
            vec2 _3404 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_15, param_16, param_17, param_18, param_19, param_20, param_21, param_22, param_23);
            pixel_to_video_uv = param_23;
            vec2 right_edge_curved_ctr_coord = _3404 - vec2(0.5);
            ...
            mat2 param_32;
            vec2 _3426 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_24, param_25, param_26, param_27, param_28, param_29, param_30, param_31, param_32);
            pixel_to_video_uv = param_32;
            vec2 bottom_edge_curved_ctr_coord = _3426 - vec2(0.5);
            ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
        ...
        if (pin_inner_edge == 1.0)
        {
            if (in_geom_tilt_angle_y != 0.0)
            {
                ...
                mat2 param_41;
                vec2 _3469 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_33, param_34, param_35, param_36, param_37, param_38, param_39, param_40, param_41);
                pixel_to_video_uv = param_41;
                vec2 top_edge_curved_ctr_coord = _3469;
            ...
            if (in_geom_tilt_angle_x != 0.0)
            {
                ...
                mat2 param_50;
                vec2 _3498 = hrg_get_curved_video_uv_coords_and_tangent_matrix(param_42, param_43, param_44, param_45, param_46, param_47, param_48, param_49, param_50);
                pixel_to_video_uv = param_50;
                vec2 left_edge_curved_ctr_coord = _3498;
...
vec2 HSM_GetCurvatureValues(float screen_aspect)
{
    ...
    {
        _3631 = vec2((((2.0 * global.HSM_CURVATURE_2D_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0, ((global.HSM_CURVATURE_2D_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0);
    }
    else
    {
        _3631 = vec2(((global.HSM_CURVATURE_2D_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0, (((2.0 * global.HSM_CURVATURE_2D_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0);
    }
    vec2 curvature_values = _3631;
...
vec2 HSM_Get2DCurvedCoord(vec2 in_coord, vec2 curvature_values)
{
    ...
    vec2 _4166 = HSM_GetCrtPiCurvedCoord(param, param_1);
    ctr_curved_coord = _4166 - vec2(0.5);
    vec2 param_2 = vec2(1.0, 0.5);
    vec2 param_3 = curvature_values;
    vec2 _4173 = HSM_GetCrtPiCurvedCoord(param_2, param_3);
    vec2 right_edge_curved_ctr_coord = _4173 - vec2(0.5);
    ctr_curved_coord.x = (ctr_curved_coord.x * 0.5) / right_edge_curved_ctr_coord.x;
    vec2 param_4 = vec2(0.5, 1.0);
    vec2 param_5 = curvature_values;
    vec2 _4187 = HSM_GetCrtPiCurvedCoord(param_4, param_5);
    vec2 bottom_edge_curved_ctr_coord = _4187 - vec2(0.5);
    ctr_curved_coord.y = (ctr_curved_coord.y * 0.5) / bottom_edge_curved_ctr_coord.y;
    return ctr_curved_coord + vec2(0.5);
}
...
vec2 HSM_GetCurvedCoord(vec2 in_coord, float curvature_multiplier, float screen_aspect)
{
    ...
    if (HSM_CURVATURE_MODE > CURVATURE_MODE_2D_CYLINDER)
    {
        ...
        else
        {
            ...
            mat2 param_16;
            vec2 _4294 = HRG_GetGeomCurvedCoord(param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16);
...
vec2 HSM_GetTubeCurvedCoord(vec2 screen_coord, float curvature_scale, vec2 screen_scale, vec2 tube_scale, float screen_aspect, float apply_black_edge_offset)
{
    ...
    if (global.HSM_BZL_USE_INDEPENDENT_CURVATURE == 1.0)
    {
        ...
        if (screen_aspect < 1.0)
        {
            _4489 = vec2((((2.0 * global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0, ((global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0);
        }
        else
        {
            _4489 = vec2(((global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_LONG_AXIS / 100.0) * 3.0) / 100.0, (((2.0 * global.HSM_BZL_INDEPENDENT_CURVATURE_SCALE_SHORT_AXIS) / 100.0) * 2.0) / 100.0);
        }
        vec2 curvature_values = _4489;
...
float HSM_GetBezelCoords(vec2 tube_diffuse_coord, vec2 tube_diffuse_scale, vec2 tube_scale, float screen_aspect, bool curve_coords_on, out vec2 bezel_outside_scale, inout vec2 bezel_outside_coord, inout vec2 bezel_outside_curved_coord, inout vec2 frame_outside_curved_coord)
{
    ...
    if (curve_coords_on)
    {
        bool _4692 = HSM_CURVATURE_MODE > 0.0;
        bool _4700;
        if (_4692)
        {
            _4700 = (HSM_CURVATURE_3D_TILT_ANGLE_X != 0.0) || (HSM_CURVATURE_3D_TILT_ANGLE_Y != 0.0);
        }
        else
        {
            _4700 = _4692;
...
{
    bool _1628 = abs(in_coord.x - 0.5) > 0.500999987125396728515625;
    bool _1638;
    if (!_1628)
    {
        _1638 = abs(in_coord.y - 0.5) > 0.500999987125396728515625;
    }
    else
    {
        _1638 = _1628;
...
vec2 HSM_GetMirrorWrappedCoord(inout vec2 in_coord)
{
    ...
    bool _4356 = abs(ctr_coord.x) > 0.5;
    bool _4364;
    if (!_4356)
    {
        _4364 = abs(ctr_coord.y) > 0.5;
    }
    else
    {
        _4364 = _4356;
...
vec4 HSM_GetCroppedTexSample(sampler2D in_sampler, vec2 in_screen_coord)
{
    ...
    vec4 _4563 = HSM_GetTexSampleFromSampleStartAndSize(in_sampler, param, param_1, param_2);
    return _4563;
}
...
float SlotMask(inout vec2 pos, float m)
{
    ...
    else
    {
        ...
        {
            bool _6098 = py == global.double_slot;
            bool _6105;
            if (_6098)
            {
                _6105 = px >= global.slotwidth;
            }
            else
            {
                _6105 = _6098;
...
vec3 Mask(inout vec2 pos, float mx, float mb, out float mask_average_luma)
{
    ...
    pos.y = floor(pos.y / final_mask_size);
    float stagg_lvl = 1.0;
    bool _4887 = fract(abs(global.mshift)) > 0.25;
    bool _4895;
    if (_4887)
    {
        _4895 = abs(global.mshift) > 1.25;
    }
    else
    {
        _4895 = _4887;
    ...
    {
        _4909 = pos0.x + (next_line * global.mshift);
    }
    else
    {
        _4909 = pos0.x + (pos.y * global.mshift);
    }
    pos0.x = _4909;
    ...
    bool _4959 = global.shadowMask == 8.0;
    bool _4967;
    if (!_4959)
    {
        _4967 = global.shadowMask == 11.0;
    }
    else
    {
        _4967 = _4959;
...
void main()
{
    ...
    {
        _711 = global.HSM_SNAP_TO_CLOSEST_INT_SCALE_TOLERANCE / 100.0;
    }
    else
    {
        _711 = 0.0;
    ...
    vec4 _6543 = HSM_UpdateGlobalScreenValuesFromCache(InfoCachePass, param_1);
    ...
    float lum = texture(AvgLumPass, vec2(0.5)).w;
    ...
    vec2 _6642 = HSM_GetMirrorWrappedCoord(param_16);
    vec2 pos = _6642;
    vec2 param_17 = pos;
    ...
    if (global.GDV_RASTER_BLOOM_ON > 0.5)
    {
        ...
        vec2 param_35 = screen_curved_coord_with_overscan;
    ...
    vec2 param_36 = pos;
    vec3 Bloom = HSM_GetCroppedTexSample(BloomPass, param_36).xyz;
    vec2 param_37 = ((screen_curved_coord - vec2(0.5)) * 0.999000012874603271484375) + vec2(0.5);
    float param_38 = SCREEN_ASPECT;
    float param_39 = global.HSM_GLOBAL_CORNER_RADIUS * (global.HSM_SCREEN_CORNER_RADIUS_SCALE / 100.0);
    float param_40 = 0.89999997615814208984375;
    ...
    if (is_inside_screen)
    {
        _6772 = global.GDV_DECONVERGENCE_ON > 0.5;
    }
    else
    {
    ...
    if (_6772)
    {
        _6799 = (((((abs(global.deconrr) + abs(global.deconrry)) + abs(global.deconrg)) + abs(global.deconrgy)) + abs(global.deconrb)) + abs(global.deconrby)) > 0.20000000298023223876953125;
    }
    else
    {
        _6799 = _6772;
    ...
    vec2 param_48 = maskcoord;
    float param_49 = mx;
    float param_50 = mb;
    float param_51 = mask_average_luma;
    vec3 _6965 = Mask(param_48, param_49, param_50, param_51);
    mask_average_luma = param_51;
    cmask *= _6965;
    if (!is_inside_screen)
    {
        vec2 param_52 = vec2(0.5);
        float param_53 = mx;
    ...
    if (interb)
    {
        ...
        {
            _7089 = pow(0.800000011920928955078125 * bb, 0.64999997615814208984375);
        }
        else
        {
            _7089 = pow(bb, 0.699999988079071044921875);
        }
        bb = _7089;
    }
    color *= bb;
    vec2 param_54 = pos;
    vec3 Ref = HSM_GetCroppedTexSample(LinearizePass, param_54).xyz;
    vec2 param_55 = pos;
    vec3 Glow = HSM_GetCroppedTexSample(GlowPass, param_55).xyz;
    vec2 param_56 = pos;
    float maxb = HSM_GetCroppedTexSample(BloomPass, param_56).w;
    vec3 Bloom1 = Bloom;
    ...
    {
        vec3 param_59 = color;
        float param_60 = mix(1.0, w3, 0.60000002384185791015625);
        vec3 _7220 = declip(param_59, param_60);
        color = _7220;
    }
    else
    {
    ...
    else
    {
        if (global.halation < (-0.00999999977648258209228515625))
        {
            ...
            vec3 param_61 = ((Bloom + Ref) + orig1) + ((Bloom * Bloom) * Bloom);
            float param_62 = min(mbl * mbl, 0.75);
    ...
    else
    {
        ...
        vec3 param_63 = orig1 + (Ref * 0.001000000047497451305389404296875);
        float param_64 = 1.0;
    ...
    bool _7493 = global.glow >= 0.0;
    bool _7499;
    if (_7493)
    {
        _7499 = global.m_glow < 0.5;
    }
    else
    {
        _7499 = _7493;
    ...
    if (global.GDV_NOISE_ON > 0.5)
    {
        ...
        {
            _7562 = global.noiseresd * global.noiseresd4kmult;
        }
        else
        {
            _7562 = global.noiseresd;
        }
        float noise_res = _7562;
        bool _7578 = global.noiseresd4kmult > 1.0;
        bool _7585;
        if (_7578)
        {
            _7585 = global.FinalViewportSize.y > 4200.0;
        }
        else
        {
            _7585 = _7578;
        ...
        vec3 param_67 = vec3(floor((global.OutputSize.xy * vTexCoord) / vec2(noise_res)), float(global.FrameCount));
        vec3 _7607 = _noise(param_67);
        vec3 noise0 = _7607;
    ...
    float param_68 = mix(pos.y, pos.x, adjusted_bardir);
    float _7657 = humbar(param_68);
    color *= _7657;
    FragColor = vec4(color, 1.0);
    vec4 param_69 = FragColor;
    float param_70 = 2.2000000476837158203125;
