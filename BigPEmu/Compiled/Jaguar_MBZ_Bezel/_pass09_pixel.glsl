...
void main()
{
    ...
    if (params.sega_fix > 0.5)
    {
        vec4 _165 = imgColor;
        vec3 _168 = _165.xyz * 1.066945552825927734375;
        imgColor.x = _168.x;
        imgColor.y = _168.y;
        imgColor.z = _168.z;
    }
    vec4 _175 = imgColor;
    vec3 _178 = min(_175.xyz, vec3(1.0));
    imgColor.x = _178.x;
    imgColor.y = _178.y;
    imgColor.z = _178.z;
    ...
    else
    {
        ...
        vec3 _226 = lut_ref;
        vec2 _234 = (_226.xy * (1.0 - invLS)) + vec2(0.5 * invLS);
        lut_ref.x = _234.x;
        lut_ref.y = _234.y;
        ...
        vec3 _371 = fix_lut(param, param_1);
        res.x = _371.x;
        res.y = _371.y;
        res.z = _371.z;
