...
void frag_main()
{
    ...
    if (false)
    {
        float4 _161 = imgColor;
        float3 _164 = _161.xyz * 1.066945552825927734375f;
        imgColor.x = _164.x;
        imgColor.y = _164.y;
        imgColor.z = _164.z;
    }
    float4 _171 = imgColor;
    float3 _174 = min(_171.xyz, 1.0f.xxx);
    imgColor.x = _174.x;
    imgColor.y = _174.y;
    imgColor.z = _174.z;
    ...
    else
    {
        ...
        float3 _223 = lut_ref;
        float2 _231 = (_223.xy * (1.0f - invLS)) + (0.5f * invLS).xx;
        lut_ref.x = _231.x;
        lut_ref.y = _231.y;
        ...
        float3 _368 = fix_lut(param, param_1);
        res.x = _368.x;
        res.y = _368.y;
        res.z = _368.z;
