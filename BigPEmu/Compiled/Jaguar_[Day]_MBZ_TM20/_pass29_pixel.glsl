...
layout(binding = 9) uniform sampler2D ReflectionPass;
...
void main()
{
    ...
    if (HHLP_IsOutsideCoordSpace(param_14))
    {
        ...
        bool _5665 = HSM_CACHE_GRAPHICS_ON > 0.5;
        bool _5671;
        if (_5665)
        {
            _5671 = feedback_color_test.w < 0.0;
        }
        else
        {
            _5671 = _5665;
        }
        if ((_5671 && (!CACHE_INFO_CHANGED)) && (HSM_RENDER_SIMPLE_MODE < 0.5))
        {
    ...
    vec2 param_22 = tube_curved_coord;
    float param_23 = TUBE_DIFFUSE_ASPECT;
    float param_24 = bezel_corner_radius;
    float param_25 = 0.9900000095367431640625;
    TUBE_MASK = HSM_GetCornerMask(param_22, param_23, param_24, param_25);
    crt_layer *= (TUBE_MASK + ((1.0 - TUBE_MASK) * under_layer.w));
    if (HSM_RENDER_SIMPLE_MODE < 0.5)
    {
        vec4 param_26 = out_color;
        vec4 param_27 = crt_layer;
        out_color = HSM_PreMultAlphaBlend(param_26, param_27);
    }
    vec4 over_layer = texture(BR_LayersOverCRTPass, vTexCoord);
    vec3 param_28 = over_layer.xyz;
    vec3 _5774 = PrepGraphicsForHDR(param_28);
    over_layer.x = _5774.x;
    over_layer.y = _5774.y;
    over_layer.z = _5774.z;
    vec4 param_29 = out_color;
    vec4 param_30 = over_layer;
    out_color = HSM_PreMultAlphaBlend(param_29, param_30);
    FragColor = out_color;
    if (HSM_RENDER_SIMPLE_MODE > 0.5)
    {
        vec2 param_31 = TUBE_DIFFUSE_COORD;
        float param_32 = 1.0;
        vec2 param_33 = TUBE_DIFFUSE_SCALE;
        vec2 param_34 = TUBE_SCALE;
        float param_35 = TUBE_DIFFUSE_ASPECT;
        float param_36 = 1.0;
        vec2 tube_curved_coord_1 = HSM_GetTubeCurvedCoord(param_31, param_32, param_33, param_34, param_35, param_36);
        vec2 param_37 = TUBE_DIFFUSE_COORD;
        float param_38 = global.HSM_TUBE_BLACK_EDGE_CURVATURE_SCALE / 100.0;
        float param_39 = TUBE_DIFFUSE_ASPECT;
        TUBE_DIFFUSE_CURVED_COORD = HSM_GetCurvedCoord(param_37, param_38, param_39);
        vec2 param_40 = ((TUBE_DIFFUSE_CURVED_COORD - vec2(0.5)) * 1.00100004673004150390625) + vec2(0.5);
        float param_41 = TUBE_DIFFUSE_ASPECT;
        float param_42 = (global.HSM_GLOBAL_CORNER_RADIUS * global.HSM_TUBE_BLACK_EDGE_CORNER_RADIUS_SCALE) / 100.0;
        float param_43 = global.HSM_TUBE_BLACK_EDGE_SHARPNESS / 100.0;
        TUBE_DIFFUSE_MASK = HSM_GetCornerMask(param_40, param_41, param_42, param_43);
        vec2 param_44 = tube_curved_coord_1;
        float param_45 = TUBE_DIFFUSE_ASPECT;
        float param_46 = bezel_corner_radius;
        float param_47 = 0.9900000095367431640625;
        TUBE_MASK = HSM_GetCornerMask(param_44, param_45, param_46, param_47);
        vec2 param_48 = BEZEL_OUTSIDE_CURVED_COORD;
        float param_49 = TUBE_DIFFUSE_ASPECT;
        float param_50 = global.HSM_GLOBAL_CORNER_RADIUS * HSM_BZL_OUTER_CORNER_RADIUS_SCALE;
        float param_51 = 0.89999997615814208984375;
        ...
        vec2 param_52 = FRAME_OUTSIDE_CURVED_COORD;
        ...
        if (HSM_RENDER_SIMPLE_MODE == 1.0)
        {
            ...
            vec4 param_57 = vec4(0.0, 0.0, 0.0, 1.0) * TUBE_MASK;
            FragColor = HSM_PreMultAlphaBlend(param_56, param_57);
        }
        if (HSM_RENDER_SIMPLE_MODE == 2.0)
        {
            vec4 param_58 = FragColor;
            vec4 param_59 = vec4(0.0, 0.0, 0.0, 1.0) * (TUBE_MASK + OUTSIDE_FRAME_MASK);
        ...
        if (HSM_RENDER_SIMPLE_MODE == 3.0)
        {
            if (HSM_RENDER_SIMPLE_MASK_TYPE == 0.0)
            {
                ...
                vec4 param_61 = vec4(1.0, 0.0, 1.0, 1.0) * TUBE_DIFFUSE_MASK;
                FragColor = HSM_PreMultAlphaBlend(param_60, param_61);
            }
            if (HSM_RENDER_SIMPLE_MASK_TYPE == 1.0)
            {
                vec4 param_62 = FragColor;
                vec4 param_63 = vec4(1.0, 0.0, 1.0, 1.0) * TUBE_MASK;
                FragColor = HSM_PreMultAlphaBlend(param_62, param_63);
            }
            if (HSM_RENDER_SIMPLE_MASK_TYPE == 2.0)
            {
                vec4 param_64 = FragColor;
                vec4 param_65 = vec4(1.0, 0.0, 1.0, 1.0) * (TUBE_MASK + OUTSIDE_FRAME_MASK);
                FragColor = HSM_PreMultAlphaBlend(param_64, param_65);
            }
            if (HSM_RENDER_SIMPLE_MASK_TYPE == 3.0)
            {
                vec4 param_66 = FragColor;
                vec4 param_67 = vec4(1.0, 0.0, 1.0, 1.0) * (1.0 - BEZEL_MASK);
                FragColor = HSM_PreMultAlphaBlend(param_66, param_67);
            }
            if (HSM_RENDER_SIMPLE_MASK_TYPE == 4.0)
            {
                vec4 param_68 = FragColor;
                vec4 param_69 = vec4(1.0, 0.0, 1.0, 1.0) * (1.0 - FRAME_MASK);
    ...
    bool _6002 = UNFLIPPED_VIEWPORT_COORD.x < (2.0 / global.OutputSize.x);
    bool _6011;
    if (_6002)
    {
        _6011 = UNFLIPPED_VIEWPORT_COORD.y < (2.0 / global.OutputSize.y);
    }
    else
    {
        _6011 = _6002;
    ...
    vec4 param_70 = FragColor;
    float param_71 = 2.2000000476837158203125;
