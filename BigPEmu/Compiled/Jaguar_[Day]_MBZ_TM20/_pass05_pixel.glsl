...
vec4 HSM_BlendModeLayerMix(vec4 color_under, inout vec4 color_over, float blend_mode, float layer_opacity)
{
    ...
    if (blend_mode == BLEND_MODE_NORMAL)
    {
        ...
        vec4 _1165 = color_over;
        vec3 _1167 = _1165.xyz * _1164;
    ...
    else
    {
        ...
        {
            vec3 _1192 = color_under.xyz + color_over.xyz;
        ...
        {
            vec3 _1208 = color_under.xyz * color_over.xyz;
...
vec4 GetColorWithIntro(vec4 in_color, inout vec2 in_coord, sampler2D in_logo_image_sampler2d)
{
    ...
    if (frame_count <= full_seq_length)
    {
        ...
        noise_color.w = 1.0;
        vec4 _2214 = noise_color;
        vec3 _2216 = _2214.xyz * 0.60000002384185791015625;
        ...
        vec4 _2233 = HSM_BlendModeLayerMix(param_9, param_10, param_11, param_12);
        out_color = _2233;
        ...
        if (intro_logo_height == 0.0)
        {
            ...
            if (abs(HSM_ROTATE_CORE_IMAGE) > 0.5)
            {
                _2257 = intro_image_res.y / global.OriginalSize.y;
            }
            else
            {
                _2257 = intro_image_res.y / global.OriginalSize.x;
            }
        ...
        vec4 _2394 = HSM_TextureQuilez(IntroImage, param_13, param_14);
        vec4 intro_image = _2394;
        ...
        if (global.HSM_INTRO_LOGO_OVER_SOLID_COLOR == 0.0)
        {
            ...
            vec4 _2446 = HSM_BlendModeLayerMix(param_17, param_18, param_19, param_20);
            out_color = _2446;
        }
        ...
        vec4 _2457 = HSM_BlendModeLayerMix(param_21, param_22, param_23, param_24);
        out_color = _2457;
        if (global.HSM_INTRO_LOGO_OVER_SOLID_COLOR == 1.0)
        {
            ...
            vec4 _2472 = HSM_BlendModeLayerMix(param_25, param_26, param_27, param_28);
            out_color = _2472;
        }
        out_color *= mask;
...
void main()
{
    ...
    {
        _400 = global.HSM_SNAP_TO_CLOSEST_INT_SCALE_TOLERANCE / 100.0;
    }
    else
    {
        _400 = 0.0;
    ...
    vec4 _2489 = HSM_UpdateGlobalScreenValuesFromCache(InfoCachePass, param);
    ...
    {
        vec4 param_1 = FragColor;
        vec2 param_2 = viewport_coord_adjusted;
        vec4 _2525 = GetColorWithIntro(param_1, param_2, IntroImage);
        FragColor = _2525;
    }
    ...
    {
        bool _2534 = HSM_CACHE_UPDATE_INDICATOR_MODE == 1.0;
        bool _2543;
        if (!_2534)
        {
            _2543 = (HSM_CACHE_GRAPHICS_ON < 0.5) && (HSM_CACHE_UPDATE_INDICATOR_MODE == 2.0);
        }
        else
        {
            _2543 = _2534;
    ...
    if (HSM_RESOLUTION_DEBUG_ON == 1.0)
    {
        ...
        vec4 _2623 = text_rgba;
        vec3 _2625 = _2623.xyz * vec3(1.0, 1.0, 0.0);
        text_rgba.x = _2625.x;
        text_rgba.y = _2625.y;
        text_rgba.z = _2625.z;
        ...
        vec4 param_5 = FragColor;
        vec4 param_6 = text_rgba;
